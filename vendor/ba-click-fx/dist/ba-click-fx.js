...
var f = Object.freeze({
	...
	"transparent-window",
	"native"
]), k = "coverage", A = "none", j = 2, M = 4, ee = 32, N = 0, te = 15.99, ne = 16, re = .01, ie = "#4ca7ff", ae = "hue-only", oe = /* @__PURE__ */ new Set(["hue-only", "relative-oklch"]), se = 1, P = Object.freeze({
	referenceHeight: p,
	rootDurationMs: 1e3,
	hit: {
		enabled: !1,
...
function me(e) {
	...
	for (let t of Object.values(e)) me(t);
...
function he(e) {
	let t = e.path.split(".")[0], n = fe[e.path], r = Object.hasOwn(de, e.path) ? de[e.path] : e.default, i = {
		...e,
		order: ue[e.path],
		group: t,
		groupOrder: le[t],
...
var ge = me([
	F("hit.enabled", "boolean", { unit: "boolean" }),
	F("hit.lifetimeMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	...
	F("flare.enabled", "boolean", { unit: "boolean" }),
	F("flare.lifetimeMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("flare.radius", "number", {
		min: 1,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("flare.rayCount", "number", {
		min: 1,
		max: 64,
		step: 1,
		unit: "count"
	}),
	F("disk.lifetimeMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("disk.radius", "number", {
		min: 1,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("rings.count", "number", {
		min: 0,
		max: 64,
		step: 1,
		unit: "count"
	}),
	F("rings.lifetimeMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("rings.radiusMin", "number", {
		min: 0,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("rings.radiusMax", "number", {
		min: 0,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("rings.bandToOuterRadius", "number", {
		min: 0,
		max: 1,
		step: 1e-4,
		unit: "ratio"
	}),
	F("rings.widthStart", "number", {
		min: 0,
		max: 8,
		step: .01,
		unit: "multiplier"
	}),
	F("rings.widthEnd", "number", {
		min: 0,
		max: 8,
		step: .01,
		unit: "multiplier"
	}),
	F("rings.angularVelocityMultiplier", "number", {
		min: 0,
		max: 100,
		step: .01,
		unit: "multiplier"
	}),
	F("rings.rotationDirection", "number", {
		min: -1,
		max: 1,
		step: 2,
		unit: "direction"
	}),
	F("rings.hdrIntensity", "number", {
		min: 0,
		max: 64,
		step: .01,
		unit: "linear-hdr"
	}),
	F("rings.arcSamples", "number", {
		min: 3,
		max: 1024,
		step: 1,
		unit: "samples"
	}),
	F("rings.radialSamples", "number", {
		min: 1,
		max: 32,
		step: 1,
		unit: "samples"
	}),
	F("rings.dissolveDirection", "number", {
		min: -1,
		max: 1,
		step: 2,
		unit: "direction"
	}),
	F("shards.hdrIntensity", "number", {
		min: 0,
		max: 64,
		step: .01,
		unit: "linear-hdr"
	}),
	F("shards.clickCount", "number", {
		min: 0,
		max: 1e3,
		step: 1,
		unit: "count"
	}),
	F("shards.clickLifetimeMinMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("shards.clickLifetimeMaxMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("shards.clickRadius", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px"
	}),
	F("shards.clickSpeedMin", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px-per-second"
	}),
	F("shards.clickSpeedMax", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px-per-second"
	}),
	F("shards.roundness", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("shards.trailLifetimeMinMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("shards.trailLifetimeMaxMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("shards.trailRadius", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px"
	}),
	F("shards.trailSpeedMin", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px-per-second"
	}),
	F("shards.trailSpeedMax", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px-per-second"
	}),
	F("shards.sizeMin", "number", {
		min: 0,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("shards.sizeMax", "number", {
		min: 0,
		max: 2e3,
		step: .01,
		unit: "px"
	}),
	F("shards.trailSpacing", "number", {
		min: 1,
		max: 5e3,
		step: .01,
		unit: "px"
	}),
	F("shards.maxCount", "number", {
		min: 0,
		max: 1e4,
		step: 1,
		unit: "count"
	}),
	F("trail.lifetimeMs", "number", {
		min: 1,
		max: 1e4,
		step: 1,
		unit: "ms"
	}),
	F("trail.geometryWidth", "number", {
		min: 0,
		max: 1e3,
		step: .01,
		unit: "px"
	}),
	F("trail.width", "number", {
		min: 0,
		max: 1e3,
		step: .01,
		unit: "px"
	}),
	F("trail.minVertexDistance", "number", {
		min: 0,
		max: 5e3,
		step: .01,
		unit: "px"
	}),
	F("trail.numCornerVertices", "number", {
		min: 0,
		max: 64,
		step: 1,
		unit: "count"
	}),
	F("trail.numCapVertices", "number", {
		min: 0,
		max: 64,
		step: 1,
		unit: "count"
	}),
	F("trail.outerGlowWidth", "number", {
		min: 0,
		max: 1e3,
		step: .1,
		unit: "px"
	}),
	F("trail.trailOpacity", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.threshold", "number", {
		min: 0,
		max: 64,
		step: .01,
		unit: "gamma-hdr"
	}),
	F("bloom.softKnee", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.clamp", "number", {
		min: 0,
		max: 65504,
		step: 1,
		unit: "gamma-hdr"
	}),
	F("bloom.intensity", "number", {
		min: 0,
		max: 10,
		step: .01,
		unit: "scalar"
	}),
	F("bloom.diffusion", "number", {
		min: 0,
		max: 10,
		step: .01,
		unit: "scalar"
	}),
	F("bloom.resolutionScale", "number", {
		min: .1,
		max: .75,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.emissionRange", "number", {
		min: 1,
		max: 65504,
		step: .01,
		unit: "linear-hdr"
	}),
	F("bloom.diskEmission", "number", {
		min: 0,
		max: 64,
		step: .01,
		unit: "linear-hdr"
	}),
	F("bloom.trailEmission", "number", {
		min: 0,
		max: 65504,
		step: .01,
		unit: "linear-hdr"
	}),
	F("bloom.trailCoverageScale", "number", {
		min: 0,
		max: 8,
		step: .01,
		unit: "multiplier"
	}),
	F("bloom.trailEmissionAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.clickEmissionScale", "number", {
		min: 0,
		max: 4,
		step: .01,
		unit: "multiplier"
	}),
	F("bloom.ringEmissionAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.diskEmissionAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.ringBlur", "number", {
		min: 0,
		max: 1e3,
		step: .1,
		unit: "px"
	}),
	F("bloom.ringAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.diskBlur", "number", {
		min: 0,
		max: 1e3,
		step: .1,
		unit: "px"
	}),
	F("bloom.diskAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
	}),
	F("bloom.trailAlpha", "number", {
		min: 0,
		max: 1,
		step: .01,
		unit: "ratio"
...
function Fe({ outputCompositing: e = S, requestedHostCompositing: t = T, hostCompositingSurface: n = D, hasCompositingReference: r = !1 } = {}) {
	let i = Me(t), a = Pe(n), o = je(i);
...
function He(e = {}, t = f) {
	let n = Ve(e.webgpuHdrPeak, t.webgpuHdrPeak ?? t.peak, j, M), r = Ve(e.webgpuHdrWhiteCore, t.webgpuHdrWhiteCore ?? t.whiteCore, 0, 1), i = Ve(e.webgpuHdrBrightness, t.webgpuHdrBrightness ?? t.brightness, 0, ee), a = Ve(e.webgpuHdrColorPreservation, t.webgpuHdrColorPreservation ?? t.colorPreservation, 0, 1), o = Ve(e.webgpuHdrWhiteStart, t.webgpuHdrWhiteStart ?? t.whiteStart, N, te), s = Ve(e.webgpuHdrWhiteEnd, t.webgpuHdrWhiteEnd ?? t.whiteEnd, .01, ne);
	return {
		webgpuHdrPeak: n,
		...
		webgpuHdrWhiteEnd: Math.max(o + re, s)
	};
}
function Ue(e = {}) {
	let t = { ...e };
	delete t.unknownBackgroundAppearance;
	let n = I.bloomBackend;
	be(e.bloomBackend) ? n = e.bloomBackend : typeof e.softwareBloomEnabled == "boolean" && (n = e.softwareBloomEnabled ? "software" : "native");
	let r = Se(e.inputSource) ? e.inputSource : I.inputSource, i = we(e.inputSamplingRate, I.inputSamplingRate), a = be(e.bloomBackend) || typeof e.softwareBloomEnabled == "boolean" ? "canvas2d" : I.effectBackend, o = ye(e.effectBackend, a), s = typeof e.webgpuPreferHdr == "boolean" ? e.webgpuPreferHdr : I.webgpuPreferHdr, c = Le(e.clickTimeScale, I.clickTimeScale), l = Le(e.trailTimeScale, I.trailTimeScale), u = Ee(e.outputCompositing, I.outputCompositing), d = De(e.overlayAlphaPolicy, I.overlayAlphaPolicy), f = Oe(e.overlayColorCompensation, I.overlayColorCompensation), p = ke(e.overlayAlphaLimit, I.overlayAlphaLimit), m = Me(e.hostCompositing, I.hostCompositing), h = Pe(e.hostCompositingSurface, I.hostCompositingSurface), g = Re(e.themeColor, I.themeColor), _ = Be(e.themeColorMode, I.themeColorMode), v = He(e, I);
	return {
		...I,
		...t,
		inputSource: r,
		...
		trailTimeScale: l,
		outputCompositing: u,
		overlayAlphaPolicy: d,
		overlayColorCompensation: f,
		overlayAlphaLimit: p,
		hostCompositing: m,
		hostCompositingSurface: h,
		themeColor: g,
		themeColorMode: _,
		...v,
		bloomBackend: n,
		softwareBloomEnabled: n === "software",
		isolatedCompositing: typeof e.isolatedCompositing == "boolean" ? e.isolatedCompositing : I.isolatedCompositing
	};
}
//#endregion
//#region src/theme-color.js
var We = 1e-5, Ge = 1e-7, Ke = 28, qe = Math.PI * 2;
function Je(e) {
...
function tt(e) {
	let [t, n, r] = $e(e.map((e) => Ye(e / 255))), i = Math.hypot(n, r);
	return [
		t,
		i,
		i <= We ? 0 : Math.atan2(r, n)
	];
}
function nt(e) {
	return e - Math.floor(e / qe) * qe;
}
function rt(e, t, n) {
	return et([
		e,
...
function at(e, t, n) {
	...
	return i.map((e) => Je(Xe(Je(e))) * 255);
}
var ot = tt(Ze(ie));
function st(e = ie) {
	let t = Ze(e), n = e.toLowerCase(), [r, i, a] = tt(t), o = i <= We;
	return Object.freeze({
		...
		targetLightness: r,
		chromaScale: o ? 0 : i / ot[1],
		hueShift: o ? 0 : nt(a - ot[2])
	});
}
function ct(e, t) {
	return t <= ot[0] || e <= ot[0] ? e * t / ot[0] : t + (e - ot[0]) * (1 - t) / (1 - ot[0]);
}
function lt(e, t) {
	if (Qe(e), !t || typeof t != "object") throw TypeError("theme 必须由 createRelativeOklchTheme 创建");
	...
	return n <= Ge ? [
		...
		0,
		0
	] : at(ct(n, t.targetLightness), r <= We ? 0 : r * t.chromaScale, nt(i + t.hueShift));
}
//#endregion
//#region src/fx-param-patch.js
var ut = new Map(ge.map((e) => [e.path, e]));
function dt(e) {
...
function gt(e, t, n) {
	let r = n, i = e, a = t, o = [];
	for (; r < 2;) {
		let e = _e.find((e) => e.fromVersion === r);
...
function yt(e, { baseline: t, reset: n = !1, resetBaseline: r = t, strict: i = !1, schemaVersion: a = 2 } = {}) {
	if (!dt(t)) throw TypeError("baseline must be a configuration object");
	if (n && !dt(r)) throw TypeError("resetBaseline must be a configuration object");
	let o = [], s = [], c = [];
	if (!Number.isInteger(a) || a < 0 || a > 2) return c.push(mt("$schemaVersion", a, "unsupported-schema-version")), vt(t, o, s, c, !1, t);
	if (!dt(e)) return c.push(mt("$patch", e, "invalid-patch")), vt(t, o, s, c, !1, t);
	let l = [];
	for (let [t, n] of Object.entries(e)) {
		let e = gt(t, n, a);
		if (e.error) {
			c.push(mt(t, n, e.error));
			continue;
		}
		l.push({
			sourcePath: t,
	...
	for (let e of u.values()) {
		...
		d.push(t);
		for (let n of e) n !== t && c.push(mt(n.sourcePath, n.sourceValue, n.migrations.length > 0 ? "migration-conflict" : "duplicate-path", { targetPath: n.path }));
	}
	d.sort((e, t) => (ut.get(e.path)?.order ?? Infinity) - (ut.get(t.path)?.order ?? Infinity) || e.sourcePath.localeCompare(t.sourcePath));
	for (let e of d) {
		let t = ut.get(e.path);
		if (!t) {
			c.push(mt(e.sourcePath, e.sourceValue, "unknown-path"));
			continue;
		}
		let n = _t(t, e.path, e.value);
		if (!n.accepted) {
			c.push(mt(e.sourcePath, e.sourceValue, n.reason));
			continue;
		}
		o.push({
			path: e.path,
	...
	if (i && c.length > 0) return vt(t, [], s, c, !1, t);
	let f = n || o.length > 0, p = ft(n ? r : t);
	for (let e of o) pt(p, e.path, e.value);
	return vt(t, o, s, c, f, p);
}
//#endregion
//#region src/bloom-color-space.js
var bt = 65504, xt = 65472;
function St(e) {
...
function wt(e = xt) {
	return Math.min(bt, Ct(Number.isFinite(e) ? e : xt));
}
//#endregion
//#region src/software-bloom.js
var L = 3, Tt = 4, Et = 64, Dt = 16, Ot = 7;
function R(e, t, n) {
...
function At(e, t, n) {
	...
	try {
		...
		for (let e = 3; e < t.data.length; e += Tt) t.data[e] > r && (t.data[e] = r, o = !0);
...
function jt(e, t, n, r) {
	...
	return {
		levelCount: R(Math.floor(o), 1, Dt),
...
function Nt(e, t, n, r, i, a, o) {
	...
	let c = Mt(s, a, o), l = c / Math.max(s, 1e-4);
	return r[i] = Math.max(0, e * l), r[i + 1] = Math.max(0, t * l), r[i + 2] = Math.max(0, n * l), c;
}
function Pt(e, t, n, r = 0, i = 0, a = r, o = 0, s = 0) {
	let c = Math.max(1, n) / 65025, l = r > 0 && i > 0, u = l ? r : e.length / Tt, d = l ? i : 1, f = l ? a : u, p = f, m = l ? s + i : 1, h = -1, g = -1, _ = 0;
	t.fill(0);
	for (let n = 0; n < d; n++) {
		let r = l ? ((s + n) * f + o) * L : 0;
		for (let i = 0; i < u; i++) {
...
function Ft(e, t, n = 0, r = 0, i = n, a = 0, o = 0) {
	let s = n > 0 && r > 0, c = s ? n : e.length / Tt, l = s ? r : 1, u = s ? i : c, d = u, f = s ? o + r : 1, p = -1, m = -1, h = 0;
	t.fill(0);
	for (let n = 0; n < l; n++) {
		let r = s ? (o + n) * u + a : 0;
		for (let i = 0; i < c; i++) {
...
function Rt(e, t, n, r, i, a, o, s = null, c = !1) {
	...
	for (let a = f; a < m; a++) {
		...
		for (let u = d; u < p; u++) {
			let d = (u + .5) * l - .5, f = 0;
			for (let r of [-o, o]) for (let i of [-o, o]) f += Lt(e, t, n, d + r, s + i) * .25;
			r[a * i + u] = c ? z(f) : Math.max(0, f);
		}
	}
}
function zt(e, t, n, r, i, a, o, s = null) {
	Rt(e, t, n, r, i, a, o, s, !0);
}
function Bt(e, t, n, r, i, a, o, s) {
	...
	for (let s = 0; s < n; s++) {
		...
		for (let l = 0; l < t; l++) {
			let d = (l + .5) * c - .5, f = 0;
			for (let e of [-u, u]) for (let t of [-u, u]) f += Lt(r, i, a, d + e, n + t) * .25;
			let p = s * t + l;
			o[p] = Math.max(0, e[p] + f);
		}
	}
}
function Vt(e, t, n, r, i, a, o, s, c = bt, l = !0, u = n / t, d = null, f = null) {
	...
	for (let a = g; a < v; a++) {
		...
		for (let u = h; u < _; u++) {
			...
			for (let i of [-1, 1]) for (let a of [-1, 1]) It(e, t, n, d + i, l + a, .25, r, m);
			let h = Nt(Math.min(c, r[m]), Math.min(c, r[m + 1]), Math.min(c, r[m + 2]), r, m, o, s), g = a * i + u;
...
function Ht(e, t, n, r, i, a) {
	...
	for (let f = 0; f < a; f++) {
		...
		for (let s = 0; s < i; s++) {
			...
			for (let i of [-1, 1]) for (let o of [-1, 1]) It(e, t, n, p + i, a + o, .25, r, m);
...
function Ut(e, t, n, r, i, a, o, s = null) {
	return Ht(e, t, n, i, a, o);
}
function Wt(e, t, n, r, i, a, o, s) {
	...
	for (let s = 0; s < n; s++) {
		...
		for (let l = 0; l < t; l++) {
			...
			for (let e of [-u, u]) for (let t of [-u, u]) It(r, i, a, d + e, n + t, .25, o, f);
		}
	}
	return {
		minimumX: 0,
...
function Gt(e, t, n, r, i, a, o, s, c = !0, l = null, u = null) {
	return Wt(e, t, n, r, i, a, o, s);
}
function Kt(e, t, r, i = e.length / L, a = null, o = null, s = null) {
	let c = St(r), l = s?.outputCompositing === "browser-overlay", u = l && je(s?.hostCompositing), d = l && !u && s?.overlayColorCompensation === "bright-core", f = l ? s?.coverage : null, p = l ? s?.sceneCoverage : null, m = z(s?.opacity ?? 1), h = z(s?.overlayAlphaLimit ?? 1), g = s?.deferOverlayAlphaLimit === !0, _ = Math.max(1, Math.floor(i)), v = Math.ceil(e.length / (_ * L)), y = a ? R(Math.floor(a.minimumX), 0, _) : 0, b = a ? R(Math.floor(a.minimumY), 0, v) : 0, x = a ? R(Math.ceil(a.maximumX + 1), y, _) : _, S = a ? R(Math.ceil(a.maximumY + 1), b, v) : v, C = Math.max(1, o?.feather ?? 1), w = o?.left, T = o?.right, E = o?.top, D = o?.bottom;
	for (let r = b; r < S; r++) {
		let i = (r * _ + y) * L, a = (r * _ + y) * Tt, s = E ? Jt(r - o.minimumY, C) : 0, v = D ? Jt(o.maximumY - r, C) : 0, b = Math.max((E?.[0] ?? 0) * s, (D?.[0] ?? 0) * v), S = Math.max((E?.[1] ?? 0) * s, (D?.[1] ?? 0) * v), O = Math.max((E?.[2] ?? 0) * s, (D?.[2] ?? 0) * v);
		for (let s = y; s < x; s++) {
			let v = w ? Jt(s - o.minimumX, C) : 0, y = T ? Jt(o.maximumX - s, C) : 0, x = Math.max(b, (w?.[0] ?? 0) * v, (T?.[0] ?? 0) * y), E = Math.max(S, (w?.[1] ?? 0) * v, (T?.[1] ?? 0) * y), D = Math.max(O, (w?.[2] ?? 0) * v, (T?.[2] ?? 0) * y), k = B(Math.max(0, e[i] - x) * c), A = B(Math.max(0, e[i + 1] - E) * c), j = B(Math.max(0, e[i + 2] - D) * c), M = Math.max(k, A, j), ee = r * _ + s, N = M, te = M;
			if (l) if (te = B(Math.max(0, f?.[ee] ?? 0) * c), u) N = Math.max(M, Math.min(1, te));
			else if (g) N = te;
			else {
			...
			if (N <= 1e-5 || !l && M <= 1e-5) t[a] = 0, t[a + 1] = 0, t[a + 2] = 0, t[a + 3] = 0;
				...
				let r = l && !u ? g ? N : Math.max(N, te) : N, o = z(k / r), s = z(A / r), p = z(j / r);
				if (d) {
					let t = Math.max(m, 1e-6), r = B(Math.max(0, f?.[ee] ?? 0) * c / t), a = kt(.25, .75, B(Math.max(e[i], e[i + 1], e[i + 2]) * c / t) / Math.max(r, 1e-6)), l = kt(.03125, .25, r), u = Math.max(o, s, p), d = n * a * l;
...
function qt(e, t, n, r, i) {
	...
	for (let i = 0; i < n; i++) for (let o = 0; o < t; o++) {
		let s = (i * t + o) * L;
		for (let c of [-a, a]) for (let l of [-a, a]) It(e, t, n, o + c, i + l, .25, r, s);
	}
}
function Jt(e, t) {
...
var Xt = class {
	...
	_resize(e, t, n, r, i, a, o) {
		let s = R(n, .1, .75), c = Math.max(1, Math.round(e * o)), l = Math.max(1, Math.round(t * o)), u = Math.max(1, Math.floor(c * s)), d = Math.max(1, Math.floor(l * s)), f = jt(r, i, s, a), p = f.levelCount, m = [], h = u, g = d;
	...
	beginFrame(e, t, n, r, i = Ot, a = 1, o = r) {
		if (this.coverageFrameReady = !1, !this.available || !r) return null;
		let s = R(a, 1, 4);
		this.displayCssWidth = e, this.displayCssHeight = t;
		let c = Math.max(1, Math.round(e * s)), l = Math.max(1, Math.round(t * s)), u = jt(c, l, n, i).levelCount, d = Math.max(Et, 2 ** Math.max(0, u - 1)), f = R(Math.floor(r.x * s / d) * d, 0, c), p = R(Math.floor(r.y * s / d) * d, 0, l), m = R(Math.ceil((r.x + r.width) * s / d) * d, 0, c), h = R(Math.ceil((r.y + r.height) * s / d) * d, 0, l), g = f / s, _ = p / s, v = m / s, y = h / s, b = v - g, x = y - _;
	...
	composite(e, t) {
		...
		if (r.width > 0 && r.height > 0) {
			...
			i = Pt(e.data, this.sourceLinear, t.encodingRange, r.width, r.height, this.sourceWidth, r.x, r.y), n && (a = Ft(o.data, this.sourceCoverage, r.width, r.height, this.sourceWidth, r.x, r.y));
		...
		if (c[0] = Vt(this.sourceLinear, this.sourceWidth, this.sourceHeight, o.down, o.width, o.height, Ct(t.threshold), t.softKnee, wt(t.clamp), !0, 1, i, s?.down), n && zt(this.sourceCoverage, this.sourceWidth, this.sourceHeight, this.sceneCoverageMip0, s.width, s.height, 1, a), !c[0]) return this._clearOutputBounds(), this._drawOutput(e);
		for (let e = 1; e < this.levels.length; e++) {
			let t = this.levels[e - 1], r = this.levels[e];
			if (c[e] = Ut(t.down, t.width, t.height, r.scratch, r.down, r.width, r.height, c[e - 1]), n) {
				let t = this.coverageLevels[e - 1], n = this.coverageLevels[e];
				Rt(t.down, t.width, t.height, n.down, n.width, n.height, 1);
			}
		}
		...
		for (let e = this.levels.length - 2; e >= 0; e--) {
			...
			if (u = Gt(t.down, t.width, t.height, l, r.width, r.height, t.up, this.sampleScale, !0, c[e], u), l = t.up, n) {
				let t = this.coverageLevels[e], n = this.coverageLevels[e + 1];
				Bt(t.down, t.width, t.height, d, n.width, n.height, t.up, this.sampleScale), d = t.up;
			}
		}
		this._clearOutputBounds();
		let f = this.levels[0].scratch;
		qt(l, this.width, this.height, f, this.sampleScale);
		let p = null;
		n && (p = this.coverageLevels[0].scratch, Rt(d, this.width, this.height, p, this.width, this.height, Math.max(0, this.sampleScale) * .5));
		let m = Yt(f, this.width, this.height, u, {
		...
		return Kt(f, this.outputImageData.data, t.intensity, this.width, u, m, {
		...
		}), this.outputBounds = u, this.outputContext.putImageData(this.outputImageData, 0, 0, u.minimumX, u.minimumY, u.maximumX - u.minimumX + 1, u.maximumY - u.minimumY + 1), this._drawOutput(e) ? (n && !je(t.hostCompositing) && t.enforceOverlayAlphaLimit === !0 && this._limitTransparentOverlayAlpha(e, t.overlayAlphaLimit), !0) : !1;
	}
	_drawOutput(e) {
...
function tn(e, t) {
	...
	for (let i = 0; i < Zt.length; i++) {
		let a = Zt[i], o = Zt[(i + 1) % Zt.length], s = o[0] - a[0], c = o[1] - a[1], l = e - a[0], u = t - a[1], d = s * s + c * c, f = $t((l * s + u * c) / d), p = l - s * f, m = u - c * f;
...
function dn() {
	let e = un(sn), t = un(cn), n = new Uint8Array(16384 * 4), r = 0;
...
function fn() {
	let e = un(ln), t = /* @__PURE__ */ new Uint8Array(16384), n = 0;
...
var mn = dn(), hn = fn(), gn = (() => {
	let e = mn.slice();
	for (let t = 0; t < hn.length; t++) e[t * 4 + 3] = hn[t];
	return e;
})();
function _n(e) {
...
function vn(e) {
	...
	for (let e = 0; e < mn.length; e += 4) l.data[e] = pn(mn[e]), l.data[e + 1] = pn(mn[e + 1]), l.data[e + 2] = pn(mn[e + 2]), l.data[e + 3] = 255, u.data[e] = mn[e], u.data[e + 1] = mn[e + 1], u.data[e + 2] = mn[e + 2], u.data[e + 3] = 255, d.data[e] = 255, d.data[e + 1] = 255, d.data[e + 2] = 255, d.data[e + 3] = mn[e + 3], f.data[e] = 255, f.data[e + 1] = 255, f.data[e + 2] = 255, f.data[e + 3] = hn[e / 4];
...
function xn(e) {
	let t = e.map(bn), n = t.reduce((e, t) => e + t.length, 0), r = new Uint8Array(n), i = 0;
...
function En(e) {
	...
	for (let e = 0; e < Tn.length; e += 4) {
		let t = wn(Tn[e]);
		s.data[e] = t, s.data[e + 1] = wn(Tn[e + 1]), s.data[e + 2] = t, s.data[e + 3] = 255, c.data[e] = Tn[e], c.data[e + 1] = Tn[e + 1], c.data[e + 2] = Tn[e + 2], c.data[e + 3] = 255, l.data[e] = 255, l.data[e + 1] = 255, l.data[e + 2] = 255, l.data[e + 3] = t;
	}
...
function Mn() {
	let e = jn(An);
	if (e.length !== kn) throw Error("[BAClickFX] invalid Ring3 alpha payload");
	let t = new Uint8Array(256 * 128);
	for (let n = 0; n < 128; n++) {
		let r = e[256 + n];
		for (let i = 0; i < 256; i++) {
			let a = n * 256 + i, o = Math.round(e[i] * r / 255), s = e[Dn + (a >> 1)];
			t[a] = o + (a & 1 ? s & 15 : s >> 4) - On;
		}
	}
	return t;
}
...
function Un(e, t) {
	...
	for (; r.offset < e.length;) {
		...
		if (a === 15 && (a += Hn(e, r)), r.offset + a > e.length || i + a > n.length) throw Error("[BAClickFX] Trail texture LZ4 literal overflow");
		...
		let s = (t & 15) + 4;
		if ((t & 15) == 15 && (s += Hn(e, r)), i + s > n.length) throw Error("[BAClickFX] Trail texture LZ4 match overflow");
		let c = i - o;
...
var Yn = Jn(Kn, qn), Xn = 6, Zn = 8, Qn = 9, $n = 9, er = 9, tr = 4096, nr = 16, rr = 1e-5, ir = Object.freeze([
	[
		0,
		1,
		1
...
function Sr(e, t, n, r) {
	let i = V(n, .1, .75), a = Math.max(1, Math.floor(e * i), Math.floor(t * i)), o = Math.log2(a) + Math.min(Math.max(0, r), 10) - 10;
	return {
		levelCount: V(Math.floor(o), 1, nr),
		sampleScale: .5 + o - Math.floor(o)
	};
}
function Cr(e, t, n) {
...
function wr(e, t, n) {
	...
	try {
		if (r = Cr(e, e.VERTEX_SHADER, t), i = Cr(e, e.FRAGMENT_SHADER, n), a = e.createProgram(), !a) throw Error("WebGL2 无法创建 Program");
...
var Tr = class {
	...
	constructor(e, t = {}) {
		this.canvas = e, this.sceneEnabled = !0, this.gl = null, this.available = !1, this.contextLost = !1, this.displayWidth = 1, this.displayHeight = 1, this.sourceWidth = 0, this.sourceHeight = 0, this.width = 0, this.height = 0, this.dpr = 1, this.resolutionScale = 0, this.diffusion = 0, this.sampleScale = 1, this.maximumTextureSize = 0, this.maximumViewportWidth = 0, this.maximumViewportHeight = 0, this.vertexCount = 0, this.vertexData = new Float32Array(tr * Xn), this.sceneDiskVertexCount = 0, this.sceneDiskVertexData = new Float32Array(tr * Zn), this.ringVertexCount = 0, this.ringVertexData = new Float32Array(tr * Qn), this.triangleVertexCount = 0, this.triangleVertexData = new Float32Array(tr * $n), this.trailVertexCount = 0, this.trailVertexData = new Float32Array(tr * er), this.sourceTarget = null, this.bloomSourceTarget = null, this.sceneOverlayTarget = null, this.levels = [], this.sceneFrameReady = !1, this.bloomSourceFrameReady = !1, this.sceneOverlayFrameReady = !1, this.sceneBackgroundFrameReady = !1, this.sceneBackgroundSource = null, this.sceneBackgroundWidth = 0, this.sceneBackgroundHeight = 0, this.sceneBackgroundUploadRetryPending = !1, this.sceneBackgroundTexture = null, this.sceneBackgroundTarget = null, this.failedResizeSignature = null, this.programs = null, this.emissionBuffer = null, this.emissionVao = null, this.sceneDiskBuffer = null, this.sceneDiskVao = null, this.ringBuffer = null, this.ringVao = null, this.ringTexture = null, this.triangleBuffer = null, this.triangleVao = null, this.triangleTexture = null, this.triangleOverlayTexture = null, this.trailTexture = null, this.circleTexture = null, this.fullscreenVao = null, this.stats = {
			vertexCount: 0,
			sceneVertexCount: 0,
	...
	_initialize() {
		try {
			...
			let r = Zn * Float32Array.BYTES_PER_ELEMENT;
			...
			let i = Qn * Float32Array.BYTES_PER_ELEMENT;
	...
	_deleteTargets() {
		...
		if (e && !this.contextLost) {
			H(e, this.sourceTarget), H(e, this.bloomSourceTarget), H(e, this.sceneOverlayTarget), H(e, this.sceneBackgroundTarget);
			for (let t of this.levels) H(e, t.down), H(e, t.scratch), H(e, t.up);
		}
	...
	_replaceSceneBackgroundTexture(e) {
		...
		return this.sceneBackgroundTexture = n, this.sceneBackgroundTarget = i, this.sceneBackgroundSource = e, this.sceneBackgroundWidth = t.width, this.sceneBackgroundHeight = t.height, this.sceneBackgroundFrameReady = !1, this.sceneBackgroundUploadRetryPending = !1, this.failedResizeSignature = null, this.gl.deleteTexture(a), H(this.gl, o), !0;
	}
	setCompositingReference(e, t = {}) {
		if (e === null) return this.gl?.deleteTexture(this.sceneBackgroundTexture), H(this.gl, this.sceneBackgroundTarget), this.sceneBackgroundSource = null, this.sceneBackgroundWidth = 0, this.sceneBackgroundHeight = 0, this.sceneBackgroundTexture = null, this.sceneBackgroundTarget = null, this.sceneBackgroundFrameReady = !1, this.sceneBackgroundUploadRetryPending = !1, this.failedResizeSignature = null, !0;
	...
	_createSceneBackgroundTarget(e, t, n) {
		...
		try {
			...
			return console.warn("[BAClickFX] Scene 背景缓冲创建失败，保留现有背景:", e), H(r, o), this._discardPendingErrors(), null;
		}
	}
	_rebuildSceneBackgroundTarget() {
		...
		return e ? (H(this.gl, this.sceneBackgroundTarget), this.sceneBackgroundTarget = e, !0) : (H(this.gl, this.sceneBackgroundTarget), this.sceneBackgroundTarget = null, !1);
	}
	...
	_ensureBloomSourceTarget() {
		return this.bloomSourceTarget?.width === this.sourceWidth && this.bloomSourceTarget?.height === this.sourceHeight ? !0 : (H(this.gl, this.bloomSourceTarget), this.bloomSourceTarget = this._createTarget(this.sourceWidth, this.sourceHeight), this.bloomSourceTarget !== null);
	}
	_allocateTargets() {
		...
		try {
			...
			let e = Sr(this.sourceWidth, this.sourceHeight, this.resolutionScale, this.diffusion), t = e.levelCount;
	...
	resize(e, t, n, r, i) {
		let a = Math.max(1, e), o = Math.max(1, t), s = V(n, 1, 4), c = V(r, .1, .75), l = Math.max(1, Math.round(a * s)), u = Math.max(1, Math.round(o * s)), d = Math.max(1, Math.floor(l * c)), f = Math.max(1, Math.floor(u * c)), p = V(i, 0, 10), m = this._createResizeSignature(l, u, d, f, p);
	...
	_drawGeometryBatches(e, t = !1, n = null) {
		...
		if (r.enable(r.BLEND), r.blendEquation(r.FUNC_ADD), this.sceneDiskVertexCount > 0) {
			...
			r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA), r.useProgram(e), r.uniform2f(r.getUniformLocation(e, "u_displaySize"), this.displayWidth, this.displayHeight), r.uniform1f(r.getUniformLocation(e, "u_emissionScale"), i), r.activeTexture(r.TEXTURE0), r.bindTexture(r.TEXTURE_2D, this.circleTexture), r.uniform1i(r.getUniformLocation(e, "u_texture"), 0), r.bindVertexArray(this.sceneDiskVao), r.bindBuffer(r.ARRAY_BUFFER, this.sceneDiskBuffer), r.bufferData(r.ARRAY_BUFFER, this.sceneDiskVertexData.subarray(0, this.sceneDiskVertexCount * Zn), r.DYNAMIC_DRAW), r.drawArrays(r.TRIANGLES, 0, this.sceneDiskVertexCount);
		}
		if (this._drawTexturedAdditiveBatch(this.trailVertexCount, this.trailVertexData.subarray(0, this.trailVertexCount * er), this.triangleBuffer, this.triangleVao, this.trailTexture, t, !1, !0), this.vertexCount > 0) {
	...
	renderScene(e = {}) {
		...
		let t = this.gl, n = e.outputCompositing === "browser-overlay" && !je(e.hostCompositing);
		try {
	...
	_ensureVertexCapacity(e) {
		let t = (this.vertexCount + e) * Xn;
		if (t <= this.vertexData.length) return;
		let n = this.vertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.vertexData.subarray(0, this.vertexCount * Xn)), this.vertexData = r;
	}
	_appendVertex(e, t, n, r, i, a) {
		let o = this.vertexCount * Xn;
		this.vertexData[o] = e, this.vertexData[o + 1] = t, this.vertexData[o + 2] = Math.max(0, n), this.vertexData[o + 3] = Math.max(0, r), this.vertexData[o + 4] = Math.max(0, i), this.vertexData[o + 5] = V(a, 0, 1), this.vertexCount++;
	}
	_ensureSceneDiskVertexCapacity(e) {
		let t = (this.sceneDiskVertexCount + e) * Zn;
		if (t <= this.sceneDiskVertexData.length) return;
		let n = this.sceneDiskVertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.sceneDiskVertexData.subarray(0, this.sceneDiskVertexCount * Zn)), this.sceneDiskVertexData = r;
	}
	_appendSceneDiskVertex(e, t, n, r, i, a, o, s) {
		let c = this.sceneDiskVertexCount * Zn;
		this.sceneDiskVertexData[c] = e, this.sceneDiskVertexData[c + 1] = t, this.sceneDiskVertexData[c + 2] = n, this.sceneDiskVertexData[c + 3] = r, this.sceneDiskVertexData[c + 4] = Math.max(0, i), this.sceneDiskVertexData[c + 5] = Math.max(0, a), this.sceneDiskVertexData[c + 6] = Math.max(0, o), this.sceneDiskVertexData[c + 7] = V(s, 0, 1), this.sceneDiskVertexCount++;
	}
	_ensureRingVertexCapacity(e) {
		let t = (this.ringVertexCount + e) * Qn;
		if (t <= this.ringVertexData.length) return;
		let n = this.ringVertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.ringVertexData.subarray(0, this.ringVertexCount * Qn)), this.ringVertexData = r;
	}
	_appendRingVertex(e, t, n, r, i, a, o, s, c) {
		let l = this.ringVertexCount * Qn;
		this.ringVertexData[l] = e, this.ringVertexData[l + 1] = t, this.ringVertexData[l + 2] = n, this.ringVertexData[l + 3] = r, this.ringVertexData[l + 4] = Math.max(0, i), this.ringVertexData[l + 5] = Math.max(0, a), this.ringVertexData[l + 6] = Math.max(0, o), this.ringVertexData[l + 7] = V(s, 0, 1), this.ringVertexData[l + 8] = V(c, 0, 1), this.ringVertexCount++;
	}
	_ensureTriangleVertexCapacity(e) {
		let t = (this.triangleVertexCount + e) * $n;
		if (t <= this.triangleVertexData.length) return;
		let n = this.triangleVertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.triangleVertexData.subarray(0, this.triangleVertexCount * $n)), this.triangleVertexData = r;
	}
	_appendTriangleVertex(e, t, n, r, i, a, o, s, c = 0) {
		let l = this.triangleVertexCount * $n;
		this.triangleVertexData[l] = e, this.triangleVertexData[l + 1] = t, this.triangleVertexData[l + 2] = n, this.triangleVertexData[l + 3] = r, this.triangleVertexData[l + 4] = Math.max(0, i), this.triangleVertexData[l + 5] = Math.max(0, a), this.triangleVertexData[l + 6] = Math.max(0, o), this.triangleVertexData[l + 7] = V(s, 0, 1), this.triangleVertexData[l + 8] = V(c, 0, 1), this.triangleVertexCount++;
	}
	_ensureTrailVertexCapacity(e) {
		let t = (this.trailVertexCount + e) * er;
		if (t <= this.trailVertexData.length) return;
		let n = this.trailVertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.trailVertexData.subarray(0, this.trailVertexCount * er)), this.trailVertexData = r;
	}
	_appendTrailVertex(e, t, n, r, i) {
		let a = this.trailVertexCount * er;
		this.trailVertexData[a] = e.x, this.trailVertexData[a + 1] = e.y, this.trailVertexData[a + 2] = t.u, this.trailVertexData[a + 3] = t.v, this.trailVertexData[a + 4] = Math.max(0, n[0]), this.trailVertexData[a + 5] = Math.max(0, n[1]), this.trailVertexData[a + 6] = Math.max(0, n[2]), this.trailVertexData[a + 7] = V(r, 0, 1), this.trailVertexData[a + 8] = V(i, 0, 1), this.trailVertexCount++;
	}
	_appendRadialDisk(e, t, n, r, i, a) {
		let o = V(Math.round(r), 24, 128), s = Math.PI * 2 / o, c = Math.cos(s), l = Math.sin(s), u = 0;
		for (let e = 0; e < ir.length - 1; e++) {
			let t = n * ir[e][0];
			u += t <= rr ? 3 : 6;
		}
		i(o * u);
		for (let r = 0; r < ir.length - 1; r++) {
			let i = ir[r], s = ir[r + 1], u = n * i[0], d = n * s[0], f = 1, p = 0;
			for (let n = 0; n < o; n++) {
	...
	addSolidDisk(e, t, n, r, i = 1, a = 48) {
		...
		let l = V(Math.round(a), 16, 128), u = Math.PI * 2 / l;
	...
	addTriangle(e, t, n, r, i, a = 1, o = 0, s = 0) {
		let c = Number.isFinite(a) ? V(a, 0, 1) : 0, l = Math.max(0, i?.[0] ?? 0), u = Math.max(0, i?.[1] ?? 0), d = Math.max(0, i?.[2] ?? 0);
		if (n <= 0 || c <= 0 || Math.max(l, u, d) <= 0) return;
		let f = Math.cos(r), p = Math.sin(r), m = n * .5, h = (n, r) => ({
			x: e + n * f - r * p,
			y: t + n * p + r * f
		}), g = h(-m, -m), _ = h(m, -m), v = h(m, m), y = h(-m, m), b = _n(o), x = +(b === 1), S = b === 1 ? 0 : 1;
	...
	addTexturedTrailTriangle(e, t, n, r, i = 1, a = 1) {
		let o = Array.isArray(r?.[0]), s = o ? r[0] : r, c = o ? r[1] : r, l = o ? r[2] : r, u = Number.isFinite(i) ? V(i, 0, 1) : 0, d = Array.isArray(a), f = d ? a[0] : a, p = d ? a[1] : a, m = d ? a[2] : a;
	...
	addDissolveRing(e, t, n, r, i, a, o, s, c, l, u, d, f) {
		...
		let g = V(Math.round(a), 1, 32), _ = V(Math.round(o), 32, 512), v = Math.max(0, n - r * .5), y = r / g, b = new Float64Array(_ + 1), x = new Float64Array(_ + 1), S = V(c, 0, 1), C = Number.isFinite(l) ? V(l, 0, 1) : 1, w = Number.isFinite(u) ? V(u, 0, 1) : 0, T = (Number.isFinite(d) ? V(d, 0, 1) : 1) - w, E = f >= 0 ? 1 : -1;
		for (let e = 0; e <= _; e++) {
	...
	addRing(e, t, n, r, i, a, o, s, c, l) {
		if (r <= 0 || c <= 0) return;
		let u = V(Math.round(a), 1, 32), d = V(Math.round(o), 32, 512), f = Math.max(0, n - r * .5), p = r / u, m = s[0] * c, h = s[1] * c, g = s[2] * c, _ = Math.PI * 2 / d, v = Math.cos(_), y = Math.sin(_), b = Math.cos(i), x = Math.sin(i);
		...
		for (let n = 0; n < u; n++) {
			...
			for (let n = 0; n < d; n++) {
				...
				let C = m * _, w = h * _, T = g * _, E = m * u, D = h * u, O = g * u, k = e + o * r, A = t + s * r, j = e + p * r, M = t + S * r, ee = e + o * i, N = t + s * i, te = e + p * i, ne = t + S * i;
				this._appendVertex(k, A, C, w, T, c * _), this._appendVertex(j, M, E, D, O, c * u), this._appendVertex(te, ne, E, D, O, c * u), this._appendVertex(k, A, C, w, T, c * _), this._appendVertex(te, ne, E, D, O, c * u), this._appendVertex(ee, N, C, w, T, c * _), o = p, s = S, _ = u;
			}
		}
	}
	...
	_renderFinal(e, t, n = !1, r = !1, i = !1) {
		...
		a.bindFramebuffer(a.FRAMEBUFFER, null), a.viewport(0, 0, this.canvas.width, this.canvas.height), a.disable(a.BLEND), a.clearColor(0, 0, 0, 0), a.clear(a.COLOR_BUFFER_BIT), a.useProgram(o), this._bindTexture(o, "u_bloom", e, 0), this._bindTexture(o, "u_scene", n ? i ? this.sceneOverlayTarget.texture : this.sourceTarget.texture : e, 1), this._bindTexture(o, "u_background", r ? this.sceneBackgroundTarget.texture : e, 2), this._bindTexture(o, "u_sceneEnergy", n ? this.sourceTarget.texture : e, 3), a.uniform1i(a.getUniformLocation(o, "u_hasScene"), +!!n), a.uniform1i(a.getUniformLocation(o, "u_hasBackground"), +!!r), a.uniform1i(a.getUniformLocation(o, "u_transparentOverlay"), +(t.outputCompositing === "browser-overlay")), a.uniform1i(a.getUniformLocation(o, "u_visualMaxAlpha"), +(t.overlayAlphaPolicy === "visual-max")), a.uniform1i(a.getUniformLocation(o, "u_brightUnknownBackground"), +(t.overlayColorCompensation === "bright-core")), a.uniform1i(a.getUniformLocation(o, "u_hostAdditive"), +!!je(t.hostCompositing)), a.uniform2f(a.getUniformLocation(o, "u_bloomTexel"), 1 / this.width, 1 / this.height), a.uniform1f(a.getUniformLocation(o, "u_sampleScale"), this.sampleScale), a.uniform1f(a.getUniformLocation(o, "u_intensity"), St(t.intensity)), a.uniform1f(a.getUniformLocation(o, "u_overlayAlphaLimit"), V(t.overlayAlphaLimit ?? 1, 0, 1)), a.uniform1f(a.getUniformLocation(o, "u_opacity"), V(t.opacity ?? 1, 0, 1)), a.bindVertexArray(this.fullscreenVao), a.drawArrays(a.TRIANGLES, 0, 3);
	}
	render(e, t = {}) {
		if (!this.available || this.contextLost || !this.sourceTarget || this.levels.length === 0) return !1;
		let n = this.gl, r = t.preserveCanvas === !0, i = r && this.sceneEnabled && this.sceneFrameReady, a = i && this.sceneBackgroundFrameReady, o = i && !a && e.outputCompositing === "browser-overlay" && !je(e.hostCompositing) && this.sceneOverlayFrameReady;
		try {
...
}, Er = "bgra8unorm", Dr = Object.freeze([
	"gpuApi",
	"context",
	"adapter",
	"device",
...
function Mr(e) {
	try {
		return e?.getPreferredCanvasFormat?.() ?? Er;
	} catch {
		return Er;
	}
}
var Nr = class {
	constructor(e, t = {}) {
		this.canvas = e, this.gpu = t.gpu ?? jr(), this.powerPreference = t.powerPreference ?? "high-performance", this.onStateChange = typeof t.onStateChange == "function" ? t.onStateChange : null, this.context = null, this.adapter = null, this.device = null, this.status = "pending", this.outputMode = "unconfigured", this.canvasFormat = null, this.preferHdr = null, this.failure = null, this._diagnosticFailureStage = null, this._diagnosticStages = Object.fromEntries(Dr.map((e) => [e, kr()])), this.ready = this._initialize();
	}
	get available() {
	...
	get diagnostics() {
		let e = Object.fromEntries(Dr.map((e) => [e, Ar(this._diagnosticStages[e])]));
		return Object.freeze({
	...
	_resetConfigurationDiagnostics() {
		this._setDiagnosticStage("extendedConfigure", "idle"), this._setDiagnosticStage("standardConfigure", "idle"), this._setDiagnosticStage("unconfigure", "idle"), Or.has(this._diagnosticFailureStage) && (this._diagnosticFailureStage = null);
	}
	_setStatus(e, t = null) {
	...
	unconfigure() {
		...
		return this.outputMode = "unconfigured", this.canvasFormat = null, this.preferHdr = null, this._setDiagnosticStage("extendedConfigure", "idle"), this._setDiagnosticStage("standardConfigure", "idle"), this._setDiagnosticStage("unconfigure", "succeeded"), Or.has(this._diagnosticFailureStage) && (this._diagnosticFailureStage = null), !0;
	}
	destroy() {
...
function Xr(e, t, n, r) {
	let i = e.createTexture({
		...
		format: Ur,
		usage: Wr.RENDER_ATTACHMENT | Wr.TEXTURE_BINDING
	});
	return {
		width: t,
		height: n,
...
function Zr(e, t, n, r, i, a) {
	let o = e.createTexture({
		...
		format: r,
		usage: Wr.COPY_DST | Wr.TEXTURE_BINDING
	}), s = r === "r8unorm" ? 1 : 4;
...
var $r = Qr(Lr, [
	...
	constructor(e, t = {}) {
		super(e, { initialize: !1 }), this.status = "pending", this.deviceManager = new Nr(e, {
			gpu: t.gpu,
			onStateChange: (e, t) => {
	...
	_createFullscreenPipeline(e, t = Ur) {
		return this.device.createRenderPipeline({
			layout: "auto",
			vertex: {
	...
	async _initializeWebGPU() {
		...
		try {
			...
			}), this.geometryUniform = this._createUniformBuffer("BA Click FX geometry uniforms", Hr), this.bloomGeometryUniform = this._createUniformBuffer("BA Click FX scaled bloom geometry uniforms", Hr), this.backgroundUniform = this._createUniformBuffer("BA Click FX background uniforms", Vr), this.prefilterUniform = this._createUniformBuffer("BA Click FX prefilter uniforms", Vr), this.finalUniform = this._createUniformBuffer("BA Click FX final uniforms", Vr), this._createMaterialTextures(), this.device.pushErrorScope?.("validation"), this._createPipelines();
	...
	_createMaterialTextures() {
		this.textures.ring = Zr(this.device, 256, 128, "r8unorm", Pn, "BA Click FX Ring3"), this.textures.circle = Zr(this.device, 512, 512, "rgba8unorm-srgb", Tn, "BA Click FX Circle_01"), this.textures.triangle = Zr(this.device, 128, 128, "rgba8unorm-srgb", mn, "BA Click FX triangle"), this.textures.triangleOverlay = Zr(this.device, 128, 128, "rgba8unorm-srgb", gn, "BA Click FX triangle overlay"), this.textures.trail = Zr(this.device, 512, 512, "rgba8unorm-srgb", Yn, "BA Click FX Trail_03"), this.placeholderTexture = Zr(this.device, 1, 1, "rgba8unorm", /* @__PURE__ */ new Uint8Array(4), "BA Click FX empty texture"), this.placeholderView = this.placeholderTexture.createView();
	}
	_createPipelines() {
		this.pipelines = {
			genericOverlay: this._createGeometryPipeline("vertexGeneric", "fragmentGeneric", $r, ri),
			genericScene: this._createGeometryPipeline("vertexGeneric", "fragmentGeneric", $r, ii),
			triangleOverlay: this._createGeometryPipeline("vertexTextured", "fragmentTriangle", ei, ri),
			triangleScene: this._createGeometryPipeline("vertexTextured", "fragmentTriangle", ei, ii),
			trailOverlay: this._createGeometryPipeline("vertexTextured", "fragmentTrail", ei, ri),
			trailScene: this._createGeometryPipeline("vertexTextured", "fragmentTrail", ei, ii),
			disk: this._createGeometryPipeline("vertexDisk", "fragmentDisk", ti, ai),
			ringOverlay: this._createGeometryPipeline("vertexRing", "fragmentRing", ni, ri),
			ringScene: this._createGeometryPipeline("vertexRing", "fragmentRing", ni, oi),
	...
	_createPassUniform(e = {}) {
		let t = /* @__PURE__ */ new ArrayBuffer(Vr), n = new Float32Array(t), r = new Uint32Array(t);
	...
	_writeGeometryUniform(e, t, n = {}) {
		let r = /* @__PURE__ */ new ArrayBuffer(Hr), i = new Float32Array(r), a = new Uint32Array(r);
	...
	_ensureVertexBuffer(e, t, n, r) {
		if (n <= 0) return null;
		let i = n * r * Ir, a = this.vertexBuffers[e];
		if (!a || a.size < i) {
			a?.buffer?.destroy?.();
			let t = Jr(i);
			a = {
	...
	_deleteTargets() {
		Yr(this.sourceTarget), Yr(this.bloomSourceTarget), Yr(this.sceneOverlayTarget);
		for (let e of this.levels) Yr(e.down), Yr(e.up), e.downUniform?.destroy?.(), e.upUniform?.destroy?.();
		this.sourceTarget = null, this.bloomSourceTarget = null, this.sceneOverlayTarget = null, this.levels = [];
	}
	_allocateTargets() {
		try {
			this._deleteTargets(), this.sourceTarget = Xr(this.device, this.sourceWidth, this.sourceHeight, "BA Click FX WebGPU scene target"), this.sceneOverlayTarget = Xr(this.device, this.sourceWidth, this.sourceHeight, "BA Click FX WebGPU scene overlay");
			let e = this.width, t = this.height, n = Sr(this.sourceWidth, this.sourceHeight, this.resolutionScale, this.diffusion);
			this.sampleScale = n.sampleScale;
			for (let r = 0; r < n.levelCount; r++) {
				let i = {
					width: e,
					height: t,
					down: Xr(this.device, e, t, `BA Click FX WebGPU bloom down ${r}`),
					up: r === n.levelCount - 1 ? null : Xr(this.device, e, t, `BA Click FX WebGPU bloom up ${r}`),
					downUniform: this._createUniformBuffer(`BA Click FX WebGPU down uniforms ${r}`, Vr),
					upUniform: this._createUniformBuffer(`BA Click FX WebGPU up uniforms ${r}`, Vr)
				};
	...
	resize(e, t, n, r, i) {
		...
		let a = Math.max(1, e), o = Math.max(1, t), s = Kr(n, 1, 4), c = Kr(r, .1, .75), l = Math.max(1, Math.round(a * s)), u = Math.max(1, Math.round(o * s)), d = Math.max(1, Math.floor(l * c)), f = Math.max(1, Math.floor(u * c)), p = Kr(i, 0, 10);
	...
	_uploadSceneBackground() {
		...
		try {
			return e = this.device.createTexture({
				...
				usage: Wr.COPY_DST | Wr.TEXTURE_BINDING | Wr.RENDER_ATTACHMENT
	...
	_ensureBloomSourceTarget() {
		return this.bloomSourceTarget?.width === this.sourceWidth && this.bloomSourceTarget?.height === this.sourceHeight ? !0 : (Yr(this.bloomSourceTarget), this.bloomSourceTarget = Xr(this.device, this.sourceWidth, this.sourceHeight, "BA Click FX WebGPU scaled bloom source"), !0);
	}
	renderScene(e = {}) {
	...
	_renderBloomPasses(e, t) {
		let n = this.bloomSourceFrameReady ? this.bloomSourceTarget : this.sourceTarget, r = this.levels[0], i = this._createPassUniform({
			...
			threshold: Ct(t.threshold),
			softKnee: Kr(t.softKnee ?? 0, 0, 1),
			clampMax: wt(t.clamp)
		});
	...
	render(e, t = {}) {
		...
		try {
			let n = t.preserveCanvas === !0 && this.sceneFrameReady, r = this.device.createCommandEncoder({ label: "BA Click FX WebGPU bloom commands" }), i = this._renderBloomPasses(r, e), [a, o] = this._getBackgroundUvScale(), s = n && this.sceneBackgroundFrameReady, c = n && !s && e.outputCompositing === "browser-overlay" && !je(e.hostCompositing) && this.sceneOverlayFrameReady, l = this._createPassUniform({
				texelX: 1 / i.width,
				texelY: 1 / i.height,
				backgroundScaleX: a,
				backgroundScaleY: o,
				sampleScale: this.sampleScale,
				intensity: St(e.intensity),
				overlayAlphaLimit: Kr(e.overlayAlphaLimit ?? 1, 0, 1),
				opacity: Kr(e.opacity ?? 1, 0, 1),
				hasScene: n,
				hasBackground: s,
				...
				hostAdditive: je(e.hostCompositing),
...
function _i(e, t, n) {
	let r = gi(e, e.VERTEX_SHADER, t), i = gi(e, e.FRAGMENT_SHADER, n), a = e.createProgram();
...
var yi = class {
	constructor(e) {
		this.canvas = e, this.gl = null, this.available = !1, this.contextLost = !1, this.destroyed = !1, this.displayWidth = 1, this.displayHeight = 1, this.dpr = 1, this.width = 0, this.height = 0, this.maximumTextureSize = 0, this.maximumViewportWidth = 0, this.maximumViewportHeight = 0, this.failedResizeSignature = null, this.finalProgram = null, this.coverageProgram = null, this.fullscreenVao = null, this.coverageVao = null, this.coverageBuffer = null, this.effectTexture = null, this.coverageTexture = null, this.coverageFramebuffer = null, this.circleTexture = null, this.backgroundTexture = null, this.backgroundSource = null, this.backgroundWidth = 0, this.backgroundHeight = 0, this.backgroundUploadRetryPending = !1, this.coverageVertexCount = 0, this.coverageVertexData = new Float32Array(li * ci), this._onContextLost = this._handleContextLost.bind(this), this._onContextRestored = this._handleContextRestored.bind(this), this.canvas?.addEventListener?.("webglcontextlost", this._onContextLost), this.canvas?.addEventListener?.("webglcontextrestored", this._onContextRestored), this._initialize();
	}
	get hasSceneBackground() {
	...
	_initialize() {
		if (!this.destroyed) try {
			...
			let t = e.getParameter(e.MAX_VIEWPORT_DIMS);
			if (this.maximumViewportWidth = t?.[0] ?? this.maximumTextureSize, this.maximumViewportHeight = t?.[1] ?? this.maximumTextureSize, this.finalProgram = _i(e, ui, pi), this.coverageProgram = _i(e, di, fi), this.fullscreenVao = e.createVertexArray(), this.coverageVao = e.createVertexArray(), this.coverageBuffer = e.createBuffer(), this.circleTexture = e.createTexture(), !this.fullscreenVao || !this.coverageVao || !this.coverageBuffer || !this.circleTexture) throw Error("Canvas Scene Final Pass 资源分配失败");
			e.bindVertexArray(this.coverageVao), e.bindBuffer(e.ARRAY_BUFFER, this.coverageBuffer);
			let n = ci * Float32Array.BYTES_PER_ELEMENT;
			e.enableVertexAttribArray(0), e.vertexAttribPointer(0, 2, e.FLOAT, !1, n, 0), e.enableVertexAttribArray(1), e.vertexAttribPointer(1, 2, e.FLOAT, !1, n, 2 * Float32Array.BYTES_PER_ELEMENT), e.enableVertexAttribArray(2), e.vertexAttribPointer(2, 1, e.FLOAT, !1, n, 4 * Float32Array.BYTES_PER_ELEMENT), e.bindVertexArray(null), e.bindBuffer(e.ARRAY_BUFFER, null), vi(e, this.circleTexture, e.LINEAR), e.texImage2D(e.TEXTURE_2D, 0, e.SRGB8_ALPHA8, 512, 512, 0, e.RGBA, e.UNSIGNED_BYTE, Tn), e.bindTexture(e.TEXTURE_2D, null), this.contextLost = !1, this.available = !0;
	...
	_createFrameResources(e, t) {
		...
		try {
			this._discardPendingErrors(), vi(n, r, n.NEAREST), n.texImage2D(n.TEXTURE_2D, 0, n.RGBA8, e, t, 0, n.RGBA, n.UNSIGNED_BYTE, null), vi(n, i, n.NEAREST), n.texImage2D(n.TEXTURE_2D, 0, n.R8, e, t, 0, n.RED, n.UNSIGNED_BYTE, null), n.bindFramebuffer(n.FRAMEBUFFER, a), n.framebufferTexture2D(n.FRAMEBUFFER, n.COLOR_ATTACHMENT0, n.TEXTURE_2D, i, 0);
	...
	resize(e, t, n) {
		...
		let r = Math.max(1, e), i = Math.max(1, t), a = mi(n, 1, 4), o = Math.max(1, Math.round(r * a)), s = Math.max(1, Math.round(i * a)), c = `${o}:${s}`;
	...
	_createBackgroundTexture(e) {
		...
		try {
			this._discardPendingErrors(), vi(t, n, t.LINEAR), t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL, !1), t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL, !1), t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL, t.NONE), t.texImage2D(t.TEXTURE_2D, 0, t.SRGB8_ALPHA8, t.RGBA, t.UNSIGNED_BYTE, e);
			let r = t.getError();
	...
	_ensureCoverageVertexCapacity(e) {
		let t = (this.coverageVertexCount + e) * ci;
		if (t <= this.coverageVertexData.length) return;
		let n = this.coverageVertexData.length;
		for (; n < t;) n = Math.ceil(n * 1.5);
		let r = new Float32Array(n);
		r.set(this.coverageVertexData.subarray(0, this.coverageVertexCount * ci)), this.coverageVertexData = r;
	}
	_appendCoverageVertex(e, t, n, r, i) {
		let a = this.coverageVertexCount * ci;
		this.coverageVertexData[a] = e, this.coverageVertexData[a + 1] = t, this.coverageVertexData[a + 2] = n, this.coverageVertexData[a + 3] = r, this.coverageVertexData[a + 4] = mi(i, 0, 1), this.coverageVertexCount++;
	}
...
function wi(e, t, n, r) {
	...
	let a = n * i * .5;
	if (i >= 1) {
		e.arc(0, 0, a, 0, bi, !1), e.closePath();
		return;
	}
	let o = n * (1 - i), s = t.map((e) => [e[0] * o, e[1] * o]), { normals: c, anticlockwise: l } = Ci(s), u = c.at(-1);
...
function ki(e, t) {
	...
	let n = Ei(t);
	if (n <= e[0][0]) return Ei(e[0][1]);
	for (let t = 1; t < e.length; t++) {
		let r = e[t - 1], i = e[t];
		if (n <= i[0]) {
			let e = i[0] - r[0], t = e > 0 ? (n - r[0]) / e : 1;
			return Ei(Di(r[1], i[1], Oi(t)));
		}
	}
	return Ei(e.at(-1)[1]);
}
function Ai(e, t) {
	let n = Ei(e) * 511, r = Ei(t) * 511, i = Math.floor(n), a = Math.floor(r), o = Math.min(511, i + 1), s = Math.min(511, a + 1), c = n - i, l = r - a;
	return Di(Di(qn[a * 512 + i], qn[a * 512 + o], c), Di(qn[s * 512 + i], qn[s * 512 + o], c), l) / 255;
}
function ji(e, t = Ti) {
	let n = Math.max(2, Math.floor(t)), r = 1 - Ei(e), i = Array(n);
	for (let e = 0; e < n; e++) {
		let t = e / (n - 1);
		i[e] = [t, Ai(r, 1 - t)];
	}
...
var U = Math.PI * 2, Mi = [
	...
	255,
	255
], Ni = "baclickfxbackendchange", Pi = "baclickfxeffectbackendchange", Fi = "baclickfxhostcompositingchange", Ii = 2 ** 53 - 1, Li = 4, Ri = 1e-6, zi = 2, Bi = 1e3, Vi = 2, W = Object.freeze({
	negative: "negative",
	positive: "positive"
});
function Hi(e, t) {
...
function Xi(e) {
	let t = String(e ?? "auto").trim().toLowerCase(), n = t ? t.split(/\s+/) : ["auto"], r = {
		...
		r.allowX = !0, r.allowY = !0, r.xDirections.add(W.negative), r.xDirections.add(W.positive), r.yDirections.add(W.negative), r.yDirections.add(W.positive);
	};
	...
	else if (e === "pan-x") r.allowX = !0, r.xDirections.add(W.negative), r.xDirections.add(W.positive), a = !0;
	else if (e === "pan-y") r.allowY = !0, r.yDirections.add(W.negative), r.yDirections.add(W.positive), a = !0;
	else if (e === "pan-left" || e === "pan-right") r.allowX = !0, r.xDirections.add(e === "pan-left" ? W.positive : W.negative), a = !0;
	else if (e === "pan-up" || e === "pan-down") r.allowY = !0, r.yDirections.add(e === "pan-up" ? W.positive : W.negative), a = !0;
	else {
		a = !1;
		break;
	}
...
var $i = 0, G = null, ea = [
	...
	167,
	255
], ta = Zi(ea[0] / 255, ea[1] / 255, ea[2] / 255)[0];
function na(e) {
	if (!/^#[0-9a-f]{6}$/i.test(e)) return 0;
	let [t, n] = Zi(parseInt(e.slice(1, 3), 16) / 255, parseInt(e.slice(3, 5), 16) / 255, parseInt(e.slice(5, 7), 16) / 255);
	return n < .02 ? 0 : t - ta;
}
function ra(e) {
	if ($i === 0) return e;
	let [t, n, r] = Zi(e[0] / 255, e[1] / 255, e[2] / 255);
	if (n < .02) return e;
	let i = t + $i;
	i -= Math.floor(i);
	let [a, o, s] = Qi(i, n, r);
...
function pa(e, t, n = [
	...
	for (let t = 1; t < e.length; t++) {
		...
		if (r <= a[0]) {
			...
			return n[0] = J(i[1][0], a[1][0], t), n[1] = J(i[1][1], a[1][1], t), n[2] = J(i[1][2], a[1][2], t), n;
		}
	}
...
function ma(e, t = 1) {
	let n = ia(e);
	return `rgba(${Math.round(K(n[0], 0, 255))}, ${Math.round(K(n[1], 0, 255))}, ${Math.round(K(n[2], 0, 255))}, ${q(t)})`;
}
function ha(e, t) {
	let n = q(e), r = Math.max(0, t);
	return 1 - (1 - n) ** r;
}
function ga(e) {
	let t = q(e / 255);
...
function Z(e, t = 1, n = !1) {
	let r = Math.max(0, t);
	return G && !G.identity ? lt(n ? e : e.map((e) => B(q(e / 255)) * 255), G).map((e) => ga(e) * r) : (G?.identity ? e : ra(e)).map((e) => (n ? ga(e) : q(e / 255)) * r);
}
function Q(e, t, n, r = null) {
	let i = e.map(([e, t]) => [e, ia(t).map(ga)]), a = Math.max(0, n), o = r ? r.map((e) => ga(e * 255)) : [
		1,
		1,
		1
	];
	return pa(i, t).map((e, t) => e * o[t] * a);
}
function _a(e, t = 1) {
	let n = q(t), r = q(e[0] * n), i = q(e[1] * n), a = q(e[2] * n), o = Math.max(r, i, a);
	return o <= 1e-5 ? "rgba(0, 0, 0, 0)" : `rgba(${Math.round(r / o * 255)}, ${Math.round(i / o * 255)}, ${Math.round(a / o * 255)}, ${o})`;
}
function va(e, t = 1, n = t) {
	let r = Math.max(0, t), i = B(Math.max(0, e[0]) * r), a = B(Math.max(0, e[1]) * r), o = B(Math.max(0, e[2]) * r), s = q(Math.max(i, a, o, q(n)));
	return s <= 1e-5 ? [
		0,
		0,
		0,
...
function ba(e, t, n, r = "none", i = 1) {
	...
	let o = Math.max(0, t), s = q(B(Math.max(0, e[0]) * o) / a), c = q(B(Math.max(0, e[1]) * o) / a), u = q(B(Math.max(0, e[2]) * o) / a);
	if (r === "bright-core") {
		let e = l([
			s * a,
			c * a,
...
function xa(e, t, n, r = 1) {
	let i = Math.max(q(r), 1e-6), a = q(q(n) / i), o = B(Math.max(...e) * Math.max(0, t) / i);
	return aa(.25, .75, o / Math.max(a, 1e-6)) * aa(.03125, .25, o);
}
function Sa(e, t, n = !1) {
	return n ? _a(Z(e, 1, !0), t) : ma(e, t);
}
function Ca(e, t, n, r = "none", i = 1, a = 1) {
	let o = q(n), s = Math.min(o, q(i));
	if (s <= 1e-5) return "rgba(0, 0, 0, 0)";
	let [c, l, u] = ba(e, t, o, r, a);
	return `rgba(${Math.round(c * 255)}, ${Math.round(l * 255)}, ${Math.round(u * 255)}, ${s})`;
}
function wa(e, t, n, r, i = "scene", a = t, o = "none", s = 1) {
	let c = q(t) * Math.max(0, n), l = e.map((e) => Math.max(0, e * c)), u = Math.max(...l);
	if (u <= 0) return "rgba(0, 0, 0, 0)";
	let d = Mt(u, Ct(r.threshold), r.softKnee);
	if (d <= 0) return "rgba(0, 0, 0, 0)";
	let f = d / u, p = l.map((e) => e * f);
	if (i === "browser-overlay") {
		let e = q(a);
		return Ca(p, r.trailAlpha, e, o, s, t);
	}
	return i === "host-additive" ? ya(p, r.trailAlpha, a) : _a(p, r.trailAlpha);
}
function Ta(e, t, n, r = 1) {
	let i = q(t) * Math.max(0, r) / Math.max(1, n);
	return `rgb(${Math.round(K(e[0] * i * 255, 0, 255))}, ${Math.round(K(e[1] * i * 255, 0, 255))}, ${Math.round(K(e[2] * i * 255, 0, 255))})`;
}
function Ea(e) {
	return typeof OffscreenCanvas < "u" && e instanceof OffscreenCanvas;
}
function Da(e) {
	return e ? typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || Ea(e) ? !0 : e?.tagName?.toLowerCase?.() === "canvas" : !1;
}
function Oa(e) {
	if (!e) return null;
	let t, n;
...
function Aa() {
	if (Ki) return Ki;
	if (qi) return null;
	let e = vn($), t = $(), n = t.getContext("2d");
	return !e || !n ? (qi = !0, null) : (t.width = 128, t.height = 128, Ki = {
		...e,
		canvas: t,
		context: n,
		linearTextureRgba: mn,
		linearTextureCoverage: hn,
...
function ja() {
	...
	if (Yi) return null;
	let e = En($);
	if (!e) return Yi = !0, null;
	let t = $(), n = $(), r = t.getContext("2d"), i = n.getContext("2d");
	return !r || !i ? (Yi = !0, null) : (t.width = 512, t.height = 512, n.width = 512, n.height = 512, Ji = {
		...e,
		tintCanvas: t,
		tintContext: r,
		outputCanvas: n,
		outputContext: i,
		linearTextureRgba: Tn,
...
function Ma(e) {
	...
	for (let n = 0, o = 0, s = 0; n < t.length; n += 4, o++, s += 3) {
		...
		e.linearTextureCoverageFromSrgbRed && (r[o] = Math.round(q(c) * 255)), i[s] = ga(t[n]), i[s + 1] = ga(t[n + 1]), i[s + 2] = ga(t[n + 2]), a[s] = i[s] * c, a[s + 1] = i[s + 1] * c, a[s + 2] = i[s + 2] * c;
	}
	e.linearTextureCoverage = r, e.linearTextureRgb = i, e.linearTextureEnergyRgb = a;
}
function Na(e, t, n, r, i, a = 0) {
	let o = K(r * t - .5, 0, t - 1), s = K(i * t - .5, 0, t - 1), c = Math.floor(o), l = Math.floor(s), u = Math.min(t - 1, c + 1), d = Math.min(t - 1, l + 1), f = o - c, p = s - l, m = e[(l * t + c) * n + a], h = e[(l * t + u) * n + a], g = e[(d * t + c) * n + a], _ = e[(d * t + u) * n + a], v = m + (h - m) * f;
	return v + (g + (_ - g) * f - v) * p;
}
var Pa = 4096, Fa = null;
function Ia() {
	if (Fa) return Fa;
	Fa = new Float32Array(Pa);
	for (let e = 0; e < Pa; e++) Fa[e] = B(e / (Pa - 1));
	return Fa;
}
function La(e, t) {
	let n = [];
...
function Ra(e, t, r, i, a, o = 0, s = 0, c = null) {
	let l = Math.max(0, Number(i) || 0), u = Math.max(0, Number(a) || 0), d = [
		0,
		1,
		2
	].map((e) => Math.max(0, Number(r[e]) || 0)), f = q(Number(s) || 0), p = q(Number(c?.roundness) || 0), m = c?.coverage ?? null, h = c?.useTextureAlpha === !0, g = p > 0 && m !== null;
	if (l <= 1e-6 || u <= 1e-6 || Math.max(...d) <= 1e-6 || e.linearTintUnavailable) return null;
	if (!e.linearTintFrames && (e.linearTintFrames = La(t, e.linearTintFrameCount), !e.linearTintFrames)) return e.linearTintUnavailable = !0, null;
	Ma(e);
	...
	let { context: b, image: x } = v, S = e.linearTextureEnergyRgb, C = e.linearTextureRgb, w = e.linearTextureCoverage, T = e.linearTextureRgba, E = Ia(), D = _ === 1, O = (e, t, n) => {
		let r = q(S[e + t] * d[t] * l), i = Math.round(r * (Pa - 1));
		return E[i] / n;
	};
	...
	for (let e = 0; e < t; e++) {
		...
		for (let i = 0; i < t; i++) {
			...
			g && ([v, y] = rn(v, y, p));
			let b = g ? (h ? Na(T, t, 4, v, y, 3) : Na(w, t, 1, v, y)) / 255 : _, S = g ? m[a] / 255 : _, D = Math.round(q(S) * 255);
			if (D === 0) {
			...
			let k = D / 255 * u, A = (e) => {
				...
				let n = 1 + (Na(C, t, 3, v, y, e) - 1) * q(b), r = q((n + (1 - n) * p) * S * d[e] * l), i = Math.round(r * (Pa - 1));
				return E[i] / k;
			}, j = A(0), M = A(1), ee = A(2), N = Math.max(j, M, ee), te = n * f * q(N);
			x.data[c] = Math.round(q(j + (N - j) * te) * 255), x.data[c + 1] = Math.round(q(M + (N - M) * te) * 255), x.data[c + 2] = Math.round(q(ee + (N - ee) * te) * 255), x.data[c + 3] = D;
		}
	}
	return b.putImageData(x, 0, 0), b.globalCompositeOperation = "source-over", b.filter = "none", v.key = y, v.canvas;
}
function za(e, t = !1) {
	let n = ja(), r = Math.max(0, ...e);
	if (!n || r <= 1e-5) return null;
	let i = e.map((e) => Math.round(q(e / r) * 255)), { tintCanvas: a, tintContext: o, outputCanvas: s, outputContext: c } = n;
...
function Va(e, t, n = "2147483647", r = "plus-lighter") {
...
function Ha(e, t, n) {
	...
	return Fn(n.textureUvMin + r * q(e), n.textureUvMin + r * q(t));
}
function Ua(e, t, n, r) {
	let i = Ha(e, t, r);
	return i >= n ? i : 0;
...
function Ga(e, t, n, r, i, a) {
	let o = e, s = t, c = Ha(Wa(o, i), n, a) >= r;
	for (let e = 0; e < 8; e++) {
		let e = (o + s) * .5;
		Ha(Wa(e, i), n, a) >= r === c ? o = e : s = e;
	}
	return (o + s) * .5;
}
function Ka(e, t, n, r, i) {
	...
	for (let e = 0; e <= o; e++) {
		let l = e / o, u = Ua(Wa(l, s), r, n, t);
		if (c !== null && c > 0 != u > 0) {
			let u = Ga((e - 1) / o, l, r, n, s, t), d = i(n), f = i(0);
...
function qa(e, t, n, r, i, a, o) {
	let s = U * t, c = Math.max(i.arcSamples, Math.ceil(s)), l = i.dissolveDirection >= 0 ? 1 : -1;
	for (let s = 0; s < c; s++) {
		let u = s / c, d = (s + 1) / c, f = Ua(Wa((u + d) * .5, l), a, r, i);
		f <= 0 || (e.beginPath(), e.arc(0, 0, t, u * U, d * U, !1), e.lineCap = "butt", e.lineWidth = Math.max(.5, n), e.strokeStyle = o(f), e.stroke());
	}
}
function Ja(e, t, n, r, i, a, o = null) {
	let s = Math.max(1, Math.round(i.radialSamples)), c = Math.max(0, t - n * .5), l = n / s;
	for (let t = 0; t < s; t++) {
		let n = c + l * t, u = c + l * (t + 1), d = (t + .5) / s, f = Ka(e, i, r, d, a);
		if (!f) {
			qa(e, (n + u) * .5, l, r, i, d, a);
			continue;
		}
		let p = t === Math.floor(s * .5);
		e.shadowBlur = p && o ? o.blur : 0, e.shadowColor = p && o ? o.color : "transparent", e.beginPath(), e.arc(0, 0, u, 0, U, !1), e.arc(0, 0, n, U, 0, !0), e.closePath(), e.fillStyle = f, e.fill();
	}
}
function Ya(e, t, n, r) {
	let i = X(r.sizeKeys, t), a = e.radius * i * n, o = J(r.widthStart, r.widthEnd, t), s = a * r.bandToOuterRadius * o;
	return {
		radius: a - s * .5,
		width: s,
		threshold: q(X(r.dissolveKeys, t))
	};
}
var Xa = [
	256,
...
function Za(e) {
	for (let t of Xa) if (e <= t) return t;
	return Xa.at(-1);
}
var Qa = class e {
	constructor(e, t) {
		this.canvas = e, this.context = t, this.resolution = 0, this.imageData = null, this.pixelOffsets = /* @__PURE__ */ new Uint32Array(), this.angularProgresses = /* @__PURE__ */ new Float32Array(), this.radialDistances = /* @__PURE__ */ new Float32Array(), this.sampleAlphas = /* @__PURE__ */ new Float32Array(), this.sampleCount = 0, this.cacheRevision = 0, this.cacheResolution = 0, this.cacheTextureUvMin = NaN, this.cacheTextureUvMax = NaN, this.cacheDissolveDirection = 0, this.cacheBandToOuterRadius = NaN, this.cacheWidthStart = NaN, this.cacheWidthEnd = NaN, this.staticWidth = !0, this.particleColor = [
			0,
			0,
			0
		], this.lastThreshold = 0, this.lastBandRatio = 0;
	}
	static create() {
		let t = $(), n = t.getContext("2d");
		return !n || typeof n.createImageData != "function" || typeof n.putImageData != "function" ? (t.width = 0, t.height = 0, null) : new e(t, n);
	}
	_resolveResolution(e, t, n, r) {
		let i = 0, a = 1;
		for (let t of e) i = Math.max(i, t.radius);
		for (let e of r.sizeKeys) a = Math.max(a, Number(e[1]) || 0);
		return Za(Math.ceil(i * a * t * Math.max(1, n) * 2));
	}
	_matchesSampleCache(e, t) {
		let n = t.dissolveDirection >= 0 ? 1 : -1;
		return this.cacheResolution === e && this.cacheTextureUvMin === t.textureUvMin && this.cacheTextureUvMax === t.textureUvMax && this.cacheDissolveDirection === n && this.cacheBandToOuterRadius === t.bandToOuterRadius && this.cacheWidthStart === t.widthStart && this.cacheWidthEnd === t.widthEnd;
	}
	_ensureSurface(e) {
		this.resolution === e && this.imageData || (this.canvas.width = e, this.canvas.height = e, this.resolution = e, this.imageData = this.context.createImageData(e, e));
	}
	_rebuildSampleCache(e, t) {
		this._ensureSurface(e);
		let n = t.dissolveDirection >= 0 ? 1 : -1, r = Math.max(0, t.widthStart, t.widthEnd), i = q(t.bandToOuterRadius * r), a = 1 - i, o = e * .5, s = 0;
		if (i > 0) for (let t = 0; t < e; t++) {
			let n = (t + .5 - o) / o;
			for (let t = 0; t < e; t++) {
				let e = (t + .5 - o) / o, r = Math.hypot(e, n);
				r >= a && r <= 1 && s++;
			}
		}
		this.pixelOffsets = new Uint32Array(s), this.angularProgresses = new Float32Array(s), this.radialDistances = new Float32Array(s), this.sampleAlphas = new Float32Array(s), this.sampleCount = s, this.staticWidth = t.widthStart === t.widthEnd;
		let c = 0;
		for (let r = 0; r < e; r++) {
			let s = (r + .5 - o) / o;
			for (let l = 0; l < e; l++) {
				let u = (l + .5 - o) / o, d = Math.hypot(u, s);
				if (d < a || d > 1) continue;
				let f = Math.atan2(s, u) / U;
				if (f < 0 && (f += 1), this.pixelOffsets[c] = (r * e + l) * 4, this.angularProgresses[c] = f, this.radialDistances[c] = d, this.staticWidth) {
					let e = i > 0 ? (d - a) / i : 0, r = Wa(f, n);
					this.sampleAlphas[c] = Ha(r, e, t);
				}
				c++;
			}
		}
		this.imageData.data.fill(0), this.cacheResolution = e, this.cacheTextureUvMin = t.textureUvMin, this.cacheTextureUvMax = t.textureUvMax, this.cacheDissolveDirection = n, this.cacheBandToOuterRadius = t.bandToOuterRadius, this.cacheWidthStart = t.widthStart, this.cacheWidthEnd = t.widthEnd, this.cacheRevision++;
	}
	_clearPixel(e, t) {
		e[t] = 0, e[t + 1] = 0, e[t + 2] = 0, e[t + 3] = 0;
	}
	_writeVisiblePixel(e, t, n, r, i, a, o = "none", s = 1) {
		let c = q(r * i);
		if (c <= 1e-5) {
			this._clearPixel(e, t);
			return;
		}
		if (a === "browser-overlay") {
			if (n.every((e) => e <= 0)) {
				this._clearPixel(e, t);
				return;
			}
			let [i, a, l] = ba(n, c, c, o, r);
			e[t] = Math.round(i * 255), e[t + 1] = Math.round(a * 255), e[t + 2] = Math.round(l * 255), e[t + 3] = Math.round(Math.min(c, q(s)) * 255);
			return;
		}
		if (a === "host-additive") {
			let [r, i, a, o] = va(n, c, c);
			e[t] = Math.round(r * 255), e[t + 1] = Math.round(i * 255), e[t + 2] = Math.round(a * 255), e[t + 3] = Math.round(o * 255);
			return;
		}
		let l = q(n[0] * c), u = q(n[1] * c), d = q(n[2] * c), f = Math.max(l, u, d);
		if (f <= 1e-5) {
			this._clearPixel(e, t);
			return;
		}
		e[t] = Math.round(l / f * 255), e[t + 1] = Math.round(u / f * 255), e[t + 2] = Math.round(d / f * 255), e[t + 3] = Math.round(f * 255);
	}
	_writeMask(e, t, n, r, i, a, o = "none", s = 1) {
		let c = i.dissolveDirection >= 0 ? 1 : -1, l = J(i.widthStart, i.widthEnd, e), u = q(i.bandToOuterRadius * Math.max(0, l)), d = 1 - u, f = this.imageData.data;
		for (let e = 0; e < this.sampleCount; e++) {
			let l = this.pixelOffsets[e], p = this.radialDistances[e];
			if (u <= 0 || p < d) {
				this._clearPixel(f, l);
				continue;
			}
			let m = this.sampleAlphas[e];
			if (!this.staticWidth) {
				let t = (p - d) / u;
				m = Ha(Wa(this.angularProgresses[e], c), t, i), this.sampleAlphas[e] = m;
			}
			if (m < t) {
				this._clearPixel(f, l);
				continue;
			}
			this._writeVisiblePixel(f, l, r, n, m, a, o, s);
		}
		this.lastThreshold = t, this.lastBandRatio = u, this.context.putImageData(this.imageData, 0, 0);
	}
	draw(e, t, n, r, i, a, o, s, c, l, u = !1, d = "none", f = 1) {
		let p = o.rings, m = o.bloom, h = this._resolveResolution(t, r, i, p);
		try {
			this._matchesSampleCache(h, p) || this._rebuildSampleCache(h, p);
			let e = q(X(p.dissolveKeys, n));
			this._writeMask(n, e, a, c, p, l, d, f);
		} catch {
			return !1;
		}
		pa(p.colorKeys, n, this.particleColor);
		let g = ha(a * m.ringAlpha, m.clickEmissionScale), _ = "transparent";
		s && (_ = l === "browser-overlay" ? Ca(Z(this.particleColor, 1, !0), g, g, d, f, a) : l === "host-additive" ? ya(Z(this.particleColor, 1, !0), g, g) : Sa(this.particleColor, g, u));
		for (let a of t) {
			let t = Ya(a, n, r, p);
			if (t.width <= .001) continue;
			let o = t.radius + t.width * .5;
			e.save(), e.translate(a.x, a.y), e.rotate(a.rotation), e.imageSmoothingEnabled = !1, e.shadowBlur = s ? m.ringBlur * r * i : 0, e.shadowColor = _, e.drawImage(this.canvas, 0, 0, this.resolution, this.resolution, -o, -o, o * 2, o * 2), e.restore();
		}
		return !0;
	}
	destroy() {
		this.canvas.width = 0, this.canvas.height = 0, this.imageData = null, this.pixelOffsets = /* @__PURE__ */ new Uint32Array(), this.angularProgresses = /* @__PURE__ */ new Float32Array(), this.radialDistances = /* @__PURE__ */ new Float32Array(), this.sampleAlphas = /* @__PURE__ */ new Float32Array(), this.sampleCount = 0;
	}
}, $a = 4, eo = 1.7, to = [
	[0, [
		0,
...
function ao(e, t, n, r, i, a = P, o = !0, s = null, c = "scene", l = !1, u = 1, d = "none", f = 1) {
	let p = a.rings, m = a.bloom, h = Ya(t, n, r, p), g = pa(p.colorKeys, n);
	if (h.width <= .001) return;
	let _ = s ?? Q(p.colorKeys, n, p.hdrIntensity), v = (e) => {
		let t = i * e;
		return c === "browser-overlay" ? Ca(_, t, t, d, f, i) : c === "host-additive" ? ya(_, t, t) : _a(_, t);
	};
	e.save(), e.translate(t.x, t.y), e.rotate(t.rotation);
	let y = ha(i * m.ringAlpha, m.clickEmissionScale), b;
	b = c === "browser-overlay" ? Ca(Z(g, 1, !0), y, y, d, f, i) : c === "host-additive" ? ya(Z(g, 1, !0), y, y) : Sa(g, y, l), Ja(e, h.radius, h.width, h.threshold, p, v, o ? {
		blur: m.ringBlur * r * u,
		color: b
	} : null), e.restore();
}
function oo(e, t, n, r, i, a = P, o = null) {
	let s = a.rings, c = a.bloom, l = Ya(t, n, r, s);
	if (l.width <= .001) return;
	let u = o ?? Q(s.colorKeys, n, s.hdrIntensity);
	e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), Ja(e, l.radius, l.width, l.threshold, s, (e) => Ta(u, i * e * c.ringEmissionAlpha, c.emissionRange, c.clickEmissionScale)), e.restore();
}
function so(e, t, n, r, i, a = P, o = !0, s = 1, c = "scene", l = "none", u = 1) {
	let d = a.disk, f = a.bloom, p = X(d.sizeKeys, n), m = d.radius * p * r, h = pa(d.colorKeys, n), g = Y(d.alphaKeys, n);
	if (m <= 0 || g <= 0) return;
	let _ = Q(d.colorKeys, n, f.diskEmission), v = g * i, y = q(v), b;
	if (c === "browser-overlay") {
		y = Math.min(y, q(u));
		let e = ja(), t = l === "bright-core" ? xa(_, i, v, i) : 0;
		e && y > 1e-6 && (b = Ra(e, 512, _, i, v, 0, t));
	} else if (c === "host-additive") {
		y = va(_, i, v)[3];
		let e = ja();
		e && (b = Ra(e, 512, _, i, y));
	} else b = za(_.map((e) => e / Math.max(g, 1e-5)));
	if (!b) return;
	e.save(), e.globalCompositeOperation = "source-over", e.translate(t.x, t.y), e.rotate(t.diskRotation), e.globalAlpha = y;
	let x = ha(i * f.diskAlpha, f.clickEmissionScale);
	c === "browser-overlay" ? e.shadowColor = Ca(Z(h, 1, !0), x, x, l, u, i) : c === "host-additive" ? e.shadowColor = ya(Z(h, 1, !0), x, x) : e.shadowColor = ma(h, x), e.shadowBlur = o ? f.diskBlur * r * s : 0, e.drawImage(b, 0, 0, 512, 512, -m, -m, m * 2, m * 2), e.restore();
}
function co(e, t, n, r, i, a = P, o = 1) {
	let s = a.disk, c = a.bloom, l = s.radius * X(s.sizeKeys, n) * r, u = c.diskBlur * r * o;
	if (l <= 0 || u <= 0) return;
	let d = pa(s.colorKeys, n), f = ha(i * c.diskAlpha, c.clickEmissionScale);
	e.save(), e.globalCompositeOperation = "lighter", e.beginPath(), e.arc(t.x, t.y, l, 0, U), e.fillStyle = "rgb(0, 0, 0)", e.shadowColor = Sa(d, f, !0), e.shadowBlur = u, e.fill(), e.restore();
}
function lo(e, t, n, r, i, a = P) {
	let o = a.disk, s = a.bloom, c = o.radius * X(o.sizeKeys, n) * r, l = za(Q(o.colorKeys, n, s.diskEmission).map((e) => e * s.clickEmissionScale / s.emissionRange));
	c <= 0 || !l || (e.save(), e.translate(t.x, t.y), e.rotate(t.diskRotation), e.globalAlpha = q(i * s.diskEmissionAlpha), e.drawImage(l, 0, 0, 512, 512, -c, -c, c * 2, c * 2), e.restore());
}
function uo(e, t, n, r, i, a = P) {
	let o = a.disk, s = o.radius * X(o.sizeKeys, n) * r, c = Y(o.alphaKeys, n) * i;
	if (s <= 0 || c <= 0) return;
	let l = ja();
	l && (e.save(), e.globalCompositeOperation = "source-over", e.translate(t.x, t.y), e.rotate(t.diskRotation), e.globalAlpha = q(c), e.shadowBlur = 0, e.shadowColor = "transparent", e.drawImage(l.coverageCanvas, 0, 0, 512, 512, -s, -s, s * 2, s * 2), e.restore());
}
function fo(e, t) {
...
function _o(e, t, n, r) {
	let i = q(n), a = go(e, i);
	if (!a || (e.roundedSceneFrames || (e.roundedSceneFrames = La(128, 2)), !e.roundedSceneFrames)) return null;
	...
	for (let e = 0; e < 128; e++) {
		let t = u ? 127 - e : e;
		for (let n = 0; n < 128; n++) {
			let r = t * 128 + n, o = (e * 128 + n) * 4, l = a[r] / 255, [u, p] = rn((n + .5) / 128, (t + .5) / 128, i), m = Na(d, 128, 4, u, p, 3) / 255;
			for (let e = 0; e < 3; e++) {
				let t = 1 + (Na(f, 128, 3, u, p, e) - 1) * q(m), n = t + (1 - t) * i;
				s.image.data[o + e] = Math.round(q(n * c[e]) * 255);
			}
			s.image.data[o + 3] = Math.round(q(l) * 255);
		}
	}
	return s.context.putImageData(s.image, 0, 0), s.key = l, s.canvas;
}
function vo(e, t, n, r, i, a, o = 1, s = "scene", c = "none", l = 1, u = 1, d = 0) {
	let f = Aa();
	if (!f) return !1;
	let p = r.map((e) => e * Math.max(0, o)), m = s === "browser-overlay" || s === "host-additive", h = go(f, d), g = h ? {
		coverage: h,
		roundness: d,
	...
	if (s === "browser-overlay") {
		_ = Math.min(_, q(l));
		let e = c === "bright-core" ? xa(p, i, i, u) : 0;
		_ > 1e-6 && (v = Ra(f, 128, p, i, i, a, e, g));
	} else if (s === "host-additive") _ = va(p, i, i)[3], v = Ra(f, 128, p, i, _, a, 0, g);
	else {
		let e = f.context, t = p.map((e) => Math.round(q(e) * 255));
		d > 0 && (v = _o(f, p, d, a)), v || (e.setTransform(1, 0, 0, 1, 0, 0), e.globalAlpha = 1, e.globalCompositeOperation = "source-over", e.imageSmoothingEnabled = !0, e.clearRect(0, 0, 128, 128), mo(e, f.colorCanvas, a), e.globalCompositeOperation = "multiply", e.fillStyle = `rgb(${t[0]}, ${t[1]}, ${t[2]})`, e.fillRect(0, 0, 128, 128), e.globalCompositeOperation = "destination-in", mo(e, f.alphaCanvas, a), v = f.canvas);
	}
...
function yo(e, t, n, r, i = P, a = "scene", o = "none", s = 1) {
	let c = i.shards, l = q(t.ageMs / t.lifetimeMs), u = t.size * X(c.sizeKeys, l) * n, d = Y(c.alphaKeys, l) * r, f = Q(c.colorKeys, l, c.hdrIntensity, c.startColor), p = fo(t, c), m = po(t, c), h = ho(c);
	u <= 0 || d <= 0 || vo(e, t, u, f, d, p, 1, a, o, s, r, h) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), wi(e, m, u, c.roundness), a === "browser-overlay" ? e.fillStyle = Ca(f, d, d, o, s, r) : a === "host-additive" ? e.fillStyle = ya(f, d, d) : e.fillStyle = _a(f, d), e.shadowColor = "transparent", e.shadowBlur = 0, e.fill(), e.restore());
}
function bo(e, t, n, r, i = P) {
	let a = i.shards, o = q(t.ageMs / t.lifetimeMs), s = t.size * X(a.sizeKeys, o) * n, c = Y(a.alphaKeys, o) * r, l = fo(t, a), u = po(t, a), d = ho(a);
	s <= 0 || c <= 0 || vo(e, t, s, [
		1,
		1,
		1
	], c, l, 1, "browser-overlay", "none", 1, r, d) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), wi(e, u, s, a.roundness), e.fillStyle = `rgba(255, 255, 255, ${q(c)})`, e.shadowColor = "transparent", e.shadowBlur = 0, e.fill(), e.restore());
}
function xo(e, t, n, r, i = P) {
	let a = i.shards, o = i.bloom, s = q(t.ageMs / t.lifetimeMs), c = t.size * X(a.sizeKeys, s) * n, l = Y(a.alphaKeys, s) * r, u = Q(a.colorKeys, s, a.hdrIntensity, a.startColor), d = fo(t, a), f = po(t, a), p = ho(a);
	c <= 0 || l <= 0 || vo(e, t, c, u, l, d, 1 / Math.max(1, o.emissionRange), "scene", "none", 1, r, p) || (e.save(), e.translate(t.x, t.y), e.rotate(t.rotation), e.beginPath(), wi(e, f, c, a.roundness), e.fillStyle = Ta(u, l, o.emissionRange), e.fill(), e.restore());
}
function So(e, t, n = P.rings) {
	return J(fa(n.angularVelocityMinKeys, t), fa(n.angularVelocityMaxKeys, t), e) * n.angularVelocityMultiplier * n.rotationDirection;
}
function Co(e, t, n, r, i, a, o = !1, s = "scene", c = "none", l = 1) {
	let u = a.hit, d = u.radius * r, f = Y(u.alphaKeys, n) * i, p = pa(u.colorKeys, n);
	f <= 0 || (e.save(), e.beginPath(), e.arc(t.x, t.y, d, 0, U), s === "browser-overlay" ? e.fillStyle = Ca(Z(p, 1, !0), f, f, c, l, i) : s === "host-additive" ? e.fillStyle = ya(Z(p, 1, !0), f, f) : e.fillStyle = Sa(p, f, o), e.fill(), e.restore());
}
function wo(e, t, n, r, i, a, o = !1, s = "scene", c = "none", l = 1) {
	let u = a.flare, d = u.radius * r, f = Y(u.alphaKeys, n) * i, p = pa(u.colorKeys, n);
	if (!(f <= 0)) {
		e.save(), e.translate(t.x, t.y), s === "browser-overlay" ? e.strokeStyle = Ca(Z(p, 1, !0), f, f, c, l, i) : s === "host-additive" ? e.strokeStyle = ya(Z(p, 1, !0), f, f) : e.strokeStyle = Sa(p, f, o);
		for (let t = 0; t < u.rayCount; t++) {
			let n = U / u.rayCount * t, i = Math.cos(n) * d, a = Math.sin(n) * d;
...
var To = class {
	constructor(e, t, n, r = null) {
		this.fx = n, this.x = e, this.y = t, this.ageMs = 0, this.lastUpdateTimeMs = Number.isFinite(r) ? r : null, this.diskRotation = ua(0, U), this.rings = [];
		let i = n.rings;
		for (let n = 0; n < i.count; n++) {
			...
			this.rings.push({
				x: e,
				y: t,
				radius: ua(i.radiusMin, i.radiusMax),
				rotation: ua(0, U),
				angularBlend: n,
				angularVelocity: So(n, 0, i)
			});
		}
	}
	update(e) {
		...
		for (let r of this.rings) {
			...
			r.angularVelocity = So(r.angularBlend, i, t), r.rotation += r.angularVelocity * (e / 1e3);
		}
	}
	updateTo(e) {
	...
	drawAdditiveBase(e, t, n, r = !1, i = "scene", a = "none", o = 1) {
		...
		this.fx.hit.enabled && s < 1 && Co(e, this, s, t, n, this.fx, r, i, a, o);
		let c = this.ageMs / this.fx.flare.lifetimeMs;
		this.fx.flare.enabled && c < 1 && wo(e, this, c, t, n, this.fx, r, i, a, o);
	}
	drawDiskLayer(e, t, n, r = !0, i = 1, a = "scene", o = "none", s = 1) {
		let c = this.ageMs / this.fx.disk.lifetimeMs;
		c < 1 && so(e, this, c, t, n, this.fx, r, i, a, o, s);
	}
	drawDiskGlow(e, t, n, r = 1) {
		let i = this.ageMs / this.fx.disk.lifetimeMs;
		i < 1 && co(e, this, i, t, n, this.fx, r);
	}
	drawBase(e, t, n, r = !0, i = "scene", a = 1, o = "none", s = 1) {
		this.drawAdditiveBase(e, t, n, !1, i, o, s), this.drawDiskLayer(e, t, n, r, a, i, o, s);
	}
	drawRings(e, t, n, r = !0, i = !1, a = null, o = 1, s = "scene", c = !1, l = "none", u = 1) {
		let d = this.ageMs / this.fx.rings.lifetimeMs;
		if (d < 1) {
			let f = Q(this.fx.rings.colorKeys, d, this.fx.rings.hdrIntensity);
			if (i && a?.draw(e, this.rings, d, t, o, n, this.fx, r, f, s, c, l, u)) return;
			for (let i of this.rings) ao(e, i, d, t, n, this.fx, r, f, s, c, o, l, u);
		}
	}
	draw(e, t, n, r = !0, i = !1, a = "scene", o = 1, s = "none", c = 1) {
		this.drawBase(e, t, n, r, a, o, s, c), this.drawRings(e, t, n, r, i, null, o, a, !1, s, c);
	}
	drawBloom(e, t, n) {
		if (this.fx.bloom.clickEmissionScale <= 0) return;
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		r < 1 && lo(e, this, r, t, n, this.fx);
		let i = this.ageMs / this.fx.rings.lifetimeMs;
		if (i < 1) {
			let r = Q(this.fx.rings.colorKeys, i, this.fx.rings.hdrIntensity);
			for (let a of this.rings) oo(e, a, i, t, n, this.fx, r);
		}
	}
	drawBloomCoverage(e, t, n) {
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		r < 1 && uo(e, this, r, t, n, this.fx);
		let i = this.ageMs / this.fx.rings.lifetimeMs;
		if (!(i >= 1)) for (let r of this.rings) ao(e, r, i, t, n, this.fx, !1, [
			1,
			1,
			1
		], "browser-overlay");
	...
	appendCanvasSceneCoverage(e, t, n) {
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		if (r >= 1) return;
		let i = this.fx.disk, a = i.radius * X(i.sizeKeys, r) * t, o = Y(i.alphaKeys, r) * n;
		e.addCoverageDisk(this.x, this.y, a, o, this.diskRotation);
	}
	appendWebGLSceneDiskLayer(e, t, n) {
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		if (r >= 1) return;
		let i = this.fx.disk, a = this.fx.bloom, o = i.radius * X(i.sizeKeys, r) * t, s = Q(i.colorKeys, r, a.diskEmission), c = Y(i.alphaKeys, r);
	...
	appendWebGLSceneAdditiveLayer(e, t, n) {
		...
		if (this.fx.hit.enabled && r < 1) {
			let i = this.fx.hit, a = Y(i.alphaKeys, r) * n;
			e.addSolidDisk(this.x, this.y, i.radius * t, Z(pa(i.colorKeys, r), 1, !0), a);
		}
		let i = this.ageMs / this.fx.flare.lifetimeMs;
		if (this.fx.flare.enabled && i < 1) {
			let r = this.fx.flare, a = Y(r.alphaKeys, i) * n, o = Z(pa(r.colorKeys, i), 1, !0), s = r.radius * t;
			for (let n = 0; n < r.rayCount; n++) {
				let i = U / r.rayCount * n;
				e.addTrailSegment({
					x: this.x,
					y: this.y
				}, {
	...
	appendWebGLBloom(e, t, n) {
		...
		let r = this.ageMs / this.fx.disk.lifetimeMs;
		if (r < 1) {
			let i = this.fx.disk, a = this.fx.bloom, o = i.radius * X(i.sizeKeys, r) * t, s = n * a.diskEmissionAlpha * a.clickEmissionScale, c = Q(i.colorKeys, r, a.diskEmission);
		...
		for (let r of this.rings) {
			let l = Ya(r, i, t, a);
			e.addRing(r.x, r.y, l.radius, l.width, r.rotation, a.radialSamples, a.arcSamples, s, n * o.ringEmissionAlpha * o.clickEmissionScale, (e, t) => Ua(c > 0 ? e : 1 - e, t, l.threshold, a));
		}
	}
	get dead() {
	...
	draw(e, t, n, r = P, i = "scene", a = "none", o = 1) {
		yo(e, this, t, n, r, i, a, o);
	}
	drawBloom(e, t, n, r = P) {
		xo(e, this, t, n, r);
	}
	drawBloomCoverage(e, t, n, r = P) {
		bo(e, this, t, n, r);
	}
	appendWebGLScene(e, t, n, r = P) {
		this.appendWebGLBloom(e, t, n, r);
	}
	appendWebGLBloom(e, t, n, r = P) {
		let i = r.shards, a = q(this.ageMs / this.lifetimeMs), o = this.size * X(i.sizeKeys, a) * t, s = Y(i.alphaKeys, a) * n, c = Q(i.colorKeys, a, i.hdrIntensity, i.startColor), l = fo(this, i);
		e.addTriangle(this.x, this.y, o, this.rotation, c, s, l, ho(i));
	}
	get dead() {
		return this.ageMs >= this.lifetimeMs;
	}
};
function Do(e, t, n, r, i, a = P.shards, o = null, s = null) {
	let c = r === "click", l = (c ? a.clickRadius : a.trailRadius) * i, u = (c ? ua(a.clickSpeedMin, a.clickSpeedMax) : ua(a.trailSpeedMin, a.trailSpeedMax)) * i, d = c ? ua(a.clickLifetimeMinMs, a.clickLifetimeMaxMs) : ua(a.trailLifetimeMinMs, a.trailLifetimeMaxMs);
	return new Eo({
		kind: r,
		x: e + Math.cos(n) * l,
		y: t + Math.sin(n) * l,
...
function Ao(e, t = P.trail) {
	return pa(t.gradient, e);
}
function jo(e, t = !1) {
...
function Mo(e, t, n = null, r = n !== null) {
	let i = jo(e, r), a = i.distances.map((e) => i.totalLength > 0 ? e / i.totalLength : 0), o = Array(Math.max(0, e.length - 1));
	...
	let s = t.coverageLongitudinalKeys, c = {
		...
		pointProgresses: a,
		segmentProgresses: o,
		pointCoverageFactors: a.map((e) => ki(s, e)),
		segmentCoverageFactors: o.map((e) => ki(s, e))
	};
	if (n === null) return c;
	...
	for (let r = 1; r < e.length; r++) {
		let e = o[r - 1], i = No(e, t, n, g);
		f.push(i), p.push(Math.max(...l[r - 1], ...i, ...l[r])), m.push(Fo(e, t, g)), h.push(ji(e));
	}
	return {
		...c,
		pointEnergies: l,
...
function No(e, t, n, r = t.textureLongitudinalKeys) {
	let i = Y(r, e);
	return Po(e, t, n).map((e) => e * i);
}
function Po(e, t, n) {
	return Z(Ao(e, t), n);
}
function Fo(e, t, n = t.textureLongitudinalKeys) {
	let r = t.textureTransverseProfileKeys;
	if (!Array.isArray(r) || r.length === 0) return [[0, 1], [1, 1]];
	let i = q(e), a = r[0], o = r[0], s = 0;
	...
	let c = Y(n, a[0]), l = Y(n, o[0]), u = Y(n, i), d = a[1].map((e, t) => {
		let n = J(e * c, o[1][t] * l, q(s));
		return u > 1e-7 ? q(n / u) : 0;
	}), f = d.length - 1, p = [];
	for (let e = f; e >= 0; e--) p.push([(f - e) / (f * 2), d[e]]);
	for (let e = 1; e <= f; e++) p.push([.5 + e / (f * 2), d[e]]);
	return p;
}
function Io(e, t, n = 0, r = 0, i = null) {
	...
	for (let t = 1; t < e.length - 1; t++) {
		...
		if (!Number.isFinite(g) || g > a * Li || _ < -n.length - 1e-6 || _ > 1e-6 || v < -1e-6 || v > r.length + 1e-6) continue;
...
function Lo(e, t, n, r) {
	...
	return e.meshCache.has(o) || e.meshCache.set(o, Io(t, n, i, a, e.measurement.segmentLengths)), e.meshCache.get(o);
}
function Ro(e) {
...
function zo(e, t, n, r, i) {
	...
	for (let [e, t] of Ro(r)) a.addColorStop(q(e), i(t, e));
	return a;
}
function Bo(e, t, n, r, i) {
	let a = zo(e, t.fromLeft, t.fromRight, r, i);
...
function Vo(e, t, n, r) {
	let i = t.points[0], a = zo(e, i, t.position === "start" ? t.points[1] : t.points[2], n, r);
...
function Ho(e, t, n, r) {
	return e.pointEnergies?.[t] ? e.pointEnergies[t] : No(e.measurement.distances[t] / e.measurement.totalLength, n, r);
}
function Uo(e, t, n) {
	let r = e.pointTransverseProfiles;
	if (r?.[t]) return r[t];
	let i = Fo(e.measurement.distances[t] / e.measurement.totalLength, n, e.textureLongitudinalKeys);
	return r && (r[t] = i), i;
}
function Wo(e, t, n) {
	...
	return ki(n.coverageLongitudinalKeys, i);
}
function Go(e, t) {
	let n = e.pointCoverageProfiles;
	if (n?.[t]) return n[t];
	let r = ji(e.pointProgresses?.[t] ?? e.measurement.distances[t] / e.measurement.totalLength);
	return n && (n[t] = r), r;
}
function Ko(e, t, n, r, i, a, o, s = 1, c = t.length - 1) {
	let l = n.measurement;
	if (l.totalLength <= 0) return;
	e.save(), e.shadowBlur = 0, e.shadowColor = "transparent";
	let u = Lo(n, t, o.scaledWidth ?? o.width * r, a), d = K(Math.floor(s), 1, t.length - 1), f = K(Math.floor(c), d, t.length - 1), p = o.colorAtIntensity ?? ((e, t, n, r) => {
		let a = o.alpha * i * t, s = o.alpha * i * n * r;
		return o.outputCompositing === "browser-overlay" ? Ca(e, a, s, o.overlayColorCompensation, o.overlayAlphaLimit, o.globalOpacity ?? i) : o.outputCompositing === "host-additive" ? ya(e, a, s) : _a(e, a);
	});
	for (let t = d; t <= f; t++) {
		let r = u.segments[t];
		if (!r) continue;
		let i = (l.distances[t - 1] + l.distances[t]) * .5 / l.totalLength, s = n.segmentEnergies?.[t - 1] ?? No(i, a, o.materialIntensity), c = n.segmentTransverseProfiles?.[t - 1] ?? Fo(i, a), d = n.segmentCoverageProfiles?.[t - 1] ?? ji(i), m = n.segmentCoverageFactors?.[t - 1] ?? ki(a.coverageLongitudinalKeys, i);
		Bo(e, r, r.endJoin?.nextSegmentIndex <= f ? r.endJoin : null, c, (e, t) => p(s, e, Y(d, t), m));
	}
	for (let t of u.caps) {
		if (t.segmentIndex < d || t.segmentIndex > f) continue;
		let r = Ho(n, t.pointIndex, a, o.materialIntensity), i = Uo(n, t.pointIndex, a), s = Go(n, t.pointIndex), c = Wo(n, t.pointIndex, a);
		Vo(e, t, i, (e, t) => p(r, e, Y(s, t), c));
	}
	e.restore();
}
function qo(e) {
...
function Jo(e, t) {
	...
	for (let e = 1; e < n.length; e++) {
		...
		i === null && (i = e - 1), a = e;
		let t = r[e - 1];
		if (!Array.isArray(t) || qo(t)) return !0;
	}
	if (i === null || !(Math.floor(t.numCapVertices ?? 0) > 0)) return !1;
	let o = e.pointEnergies?.[i], s = e.pointEnergies?.[a];
	return !Array.isArray(o) || !Array.isArray(s) ? !0 : qo(o) || qo(s);
}
function Yo(e, t, n, r, i, a, o, s, c = "scene", l = "none", u = 1) {
	if (n.measurement.totalLength <= 0 || i <= 0 || o.trailAlpha <= 0 || o.trailEmission <= 0 || typeof e.filter != "string" || !s?.context || !Jo(n, a)) return;
	...
	(O.width !== A || O.height !== j) && (O.width = A, O.height = j), k.setTransform(1, 0, 0, 1, 0, 0), k.clearRect(0, 0, E, D), k.setTransform(T, 0, 0, T, -x * T, -S * T), k.globalCompositeOperation = "lighter", k.filter = "none", Ko(k, t, n, r, i, a, {
		width: a.geometryWidth,
		materialIntensity: o.trailEmission,
		colorAtIntensity: (e, t, n, r) => wa(e, i, t, o, c, i * n * r, l, u)
	}, f), e.save(), e.filter = `blur(${p * T}px)`, e.shadowBlur = 0, e.shadowColor = "transparent", e.drawImage(O, 0, 0, E, D, x, S, C, w), e.restore();
}
function Xo(e, t, n, r, i, a, o, s = !1, c = "scene", l = "none", u = 1) {
	let d = n.measurement, f = o.alpha * i;
	if (d.totalLength <= 0 || f <= 0) return;
	if (e.save(), e.lineWidth = Math.max(.5, o.width * r), e.shadowBlur = 0, e.shadowColor = "transparent", o.color && c === "scene") {
		e.lineJoin = "round", e.lineCap = "round", e.strokeStyle = Sa(o.color, f, s), e.beginPath(), e.moveTo(t[0].x, t[0].y);
		for (let n = 1; n < t.length; n++) e.lineTo(t[n].x, t[n].y);
		e.stroke(), e.restore();
		return;
	}
	e.lineCap = "butt";
	let p = d.distances, m = d.totalLength, h = o.gradient ? o.gradient : a.gradient, g = [
		0,
		0,
		0
	];
	for (let r = 1; r < t.length; r++) {
		let d = n.segmentProgresses?.[r - 1] ?? (p[r - 1] + p[r]) * .5 / m;
		o.color ? (g[0] = o.color[0], g[1] = o.color[1], g[2] = o.color[2]) : pa(h, d, g);
		let _ = o.color ? 1 : d ** .5, v = n.segmentCoverageFactors?.[r - 1] ?? ki(a.coverageLongitudinalKeys, d);
		e.beginPath(), e.moveTo(t[r - 1].x, t[r - 1].y), e.lineTo(t[r].x, t[r].y), c === "browser-overlay" ? e.strokeStyle = Ca(Z(g, 1, !0), f * _, f * v, l, u, i) : c === "host-additive" ? e.strokeStyle = ya(Z(g, 1, !0), f * _, f * v) : e.strokeStyle = Sa(g, f * _, s), e.stroke();
	}
	e.restore();
}
function Zo(e, t, n, r, i = P, a = !0, o = !1, s = null, c = null, l = !1, u = "scene", d = "none", f = 1) {
	let p = i.trail, m = i.bloom, h = r * (p.trailOpacity ?? 1), g = c ?? Mo(t, p, o ? null : m.trailEmission);
	if (g.measurement, o) {
		m.trailAlpha !== 0 && Xo(e, t, g, n, h, p, {
			width: p.outerGlowWidth,
			alpha: m.trailAlpha,
			color: no
		}, l, u, d, f), Xo(e, t, g, n, h, p, ro, l, u, d, f), Xo(e, t, g, n, h, p, io, l, u, d, f);
		return;
	}
	a && Yo(e, t, g, n, h, p, m, s, u, d, f), Ko(e, t, g, n, h, p, {
		width: p.width,
		alpha: 1,
		materialIntensity: m.trailEmission,
		outputCompositing: u,
		overlayColorCompensation: d,
		overlayAlphaLimit: f
	});
}
function Qo(e, t, n, r, i = P, a = null, o = 1, s = t.length - 1) {
	let c = i.trail, l = r * (c.trailOpacity ?? 1), u = a ?? Mo(t, c, 1);
	u.measurement.totalLength <= 0 || l <= 0 || Ko(e, t, u, n, 1, c, {
		width: c.width,
		colorAtIntensity: (e, t, n, r) => `rgba(255, 255, 255, ${q(l * n * r)})`
	}, o, s);
}
function $o(e, t, n, r, i = P, a = null, o = 1, s = t.length - 1) {
	let c = i.trail, l = i.bloom, u = r * (c.trailOpacity ?? 1) * l.trailEmissionAlpha, d = a ?? Mo(t, c, l.trailEmission);
	if (d.measurement.totalLength <= 0 || u <= 0) return;
	let f = Math.max(.5, c.geometryWidth * n * l.trailCoverageScale), p = K(Math.floor(o), 1, t.length - 1), m = K(Math.floor(s), p, t.length - 1);
	Ko(e, t, d, n, 1, c, {
		scaledWidth: f,
		alpha: 1,
		materialIntensity: l.trailEmission,
		colorAtIntensity: (e, t) => Ta(e, u * t, l.emissionRange)
	}, p, m);
}
function es(e, t, n) {
	return {
...
function ts(e, t, n, r, i) {
	let a = es(t.fromLeft, n.u, 1), o = es(t.fromRight, n.u, 0), s = es(t.toLeft, r.u, 1), c = es(t.toRight, r.u, 0);
...
function ns(e, t, n, r) {
	let i = +(t.innerSide === "left"), a = 1 - i, o = es(t.inner, n.u, i);
	for (let i = 1; i < t.outerArc.length; i++) {
		let s = es(t.outerArc[i - 1], n.u, a), c = es(t.outerArc[i], n.u, a);
...
function rs(e, t, n, r, i) {
	for (let a of t.caps) {
		...
		let t = r[a.pointIndex], o = a.position === "start" ? [
			...
			.5,
			0
		], s = a.points.map((e, n) => es(e, t.u, o[n]));
...
function is(e, t, n, r, i) {
	for (let a = 1; a < t.segments.length; a++) {
		...
		!o || !n.has(a) || !n.has(o.nextSegmentIndex) || ns(e, o, r[a], i);
	}
}
function as(e, t, n, r, i = P, a = null) {
	let o = i.trail, s = i.bloom, c = r * (o.trailOpacity ?? 1), l = a ?? Mo(t, o, s.trailEmission), u = o.width * n;
	if (l.measurement.totalLength <= 0 || c <= 0 || u <= 0) return;
	let d = Lo(l, t, u, o), f = /* @__PURE__ */ new Set(), p = Array(t.length);
	for (let e = 0; e < t.length; e++) {
		let t = l.pointProgresses?.[e] ?? l.measurement.distances[e] / l.measurement.totalLength;
		p[e] = {
			u: 1 - t,
			color: Po(t, o, s.trailEmission),
			coverage: Wo(l, e, o)
		};
	}
	for (let n = 1; n < t.length; n++) {
		let t = d.segments[n];
		t && (f.add(n), ts(e, t, p[n - 1], p[n], c));
	}
	is(e, d, f, p, c), rs(e, d, f, p, c);
}
var os = class {
	constructor(e = {}) {
		...
		if (!t && !Ea(e.target)) throw Error("BAClickFX 在 Worker 中需要显式传入 OffscreenCanvas target");
		let n = typeof e.softwareBloomEnabled == "boolean" ? e.softwareBloomEnabled ? "software" : "native" : I.bloomBackend, r = xe(e.bloomBackend, n), i = be(e.bloomBackend) || typeof e.softwareBloomEnabled == "boolean" ? "canvas2d" : I.effectBackend;
		if (this.config = Ue({
			scale: Number.isFinite(e.scale) ? Math.max(.01, e.scale) : I.scale,
			opacity: Number.isFinite(e.opacity) ? q(e.opacity) : I.opacity,
			themeColor: Re(e.themeColor, I.themeColor),
			themeColorMode: Be(e.themeColorMode, I.themeColorMode),
			clickEnabled: e.clickEnabled ?? I.clickEnabled,
			trailEnabled: e.trailEnabled ?? I.trailEnabled,
			trailAlways: e.trailAlways ?? I.trailAlways,
			inputSource: Se(e.inputSource) ? e.inputSource : I.inputSource,
			inputSamplingRate: we(e.inputSamplingRate, I.inputSamplingRate),
			clickTimeScale: Le(e.clickTimeScale, I.clickTimeScale),
			trailTimeScale: Le(e.trailTimeScale, I.trailTimeScale),
			outputCompositing: Te(e.outputCompositing) ? e.outputCompositing : I.outputCompositing,
			overlayAlphaPolicy: De(e.overlayAlphaPolicy, I.overlayAlphaPolicy),
			overlayColorCompensation: Oe(e.overlayColorCompensation, I.overlayColorCompensation),
			overlayAlphaLimit: ke(e.overlayAlphaLimit, I.overlayAlphaLimit),
			hostCompositing: Me(e.hostCompositing, I.hostCompositing),
			hostCompositingSurface: Pe(e.hostCompositingSurface, I.hostCompositingSurface),
			effectBackend: ye(e.effectBackend, i),
			webgpuPreferHdr: typeof e.webgpuPreferHdr == "boolean" ? e.webgpuPreferHdr : I.webgpuPreferHdr,
			webgpuHdrPeak: e.webgpuHdrPeak,
			webgpuHdrBrightness: e.webgpuHdrBrightness,
			webgpuHdrColorPreservation: e.webgpuHdrColorPreservation,
			webgpuHdrWhiteCore: e.webgpuHdrWhiteCore,
			webgpuHdrWhiteStart: e.webgpuHdrWhiteStart,
			webgpuHdrWhiteEnd: e.webgpuHdrWhiteEnd,
			renderingMode: e.renderingMode === "legacy" ? "legacy" : I.renderingMode,
			bloomBackend: r,
			softwareBloomEnabled: r === "software",
			isolatedCompositing: typeof e.isolatedCompositing == "boolean" ? e.isolatedCompositing : I.isolatedCompositing,
			lightBackgroundContrastAlpha: Number.isFinite(e.lightBackgroundContrastAlpha) ? q(e.lightBackgroundContrastAlpha) : I.lightBackgroundContrastAlpha,
			maxDpr: Number.isFinite(e.maxDpr) ? Math.max(1, e.maxDpr) : I.maxDpr,
			touchAction: e.touchAction ?? I.touchAction
		}), this.inputFilter = typeof e.inputFilter == "function" ? e.inputFilter : null, this.host = ka(e.target), this.ownsCanvas = !Da(this.host), this.ownsCanvas || (this.config.isolatedCompositing = !1), this.canvas = Da(this.host) ? this.host : $(), this.contrastCanvas = this.ownsCanvas ? $() : null, this.webglBloomCanvas = null, this.webglBloomRenderer = null, this.webglBloomUnavailable = !1, this.webglBloomVisible = !1, this.webglEffectCanvas = null, this.webglEffectRenderer = null, this.webglEffectUnavailable = !1, this.webglEffectVisible = !1, this.webgpuEffectCanvas = null, this.webgpuEffectRenderer = null, this.webgpuEffectUnavailable = !1, this.webgpuEffectVisible = !1, this.canvasSceneCanvas = null, this.canvasSceneRenderer = null, this.canvasSceneUnavailable = !1, this.canvasSceneVisible = !1, this.compositingReferenceSource = null, this.compositingReferenceFit = "cover", this.compositingMountPending = !1, this.hostCompositingState = this._resolveHostCompositingState(), !this.canvas) throw Error("BAClickFX 找不到 target");
		if (this.ownsCanvas) {
			let e = this.host ?? document.body, t = this.config.renderingMode === "legacy";
			this.overlayMountParent = e, this.overlayRoot = Ba(!this.host), t ? (Va(this.canvas, !1, "2147483647", ""), Va(this.contrastCanvas, !1, "2147483647", "darken"), this.contrastCanvas.style.display = "none") : (Va(this.canvas, !1, "2147483646", ""), Va(this.contrastCanvas, !1, "2147483647", "darken")), this._applyCompositingMount();
		...
		let a = Ea(this.canvas), o = !a || this.config.effectBackend === "canvas2d" || this.config.renderingMode === "legacy";
		...
		this.bloomRenderer = new Xt(() => $()), this.bloomRenderers = [this.bloomRenderer], this.resolvedEffectBackend = this._getRequestedEffectBackendState(), this.resolvedBloomBackend = this._getRequestedBloomBackendState(), this.softwareBloomFrameStats = {
			regionCount: 0,
			...
			levelCount: 0,
			bloomPixels: 0
		}, this.nativeTrailBloomSurface = void 0, this.legacyRingRasterizer = void 0, this.width = 0, this.height = 0, this.dpr = 1, this.fxConfig = structuredClone(P), this._themeHueShift = na(this.config.themeColor), this._relativeOklchTheme = this.config.themeColorMode === "relative-oklch" ? st(this.config.themeColor) : null, this.config.renderingMode === "legacy" && this._applyLegacyParams(), this.waves = [], this.shards = [], this.trailStrokes = [], this.currentTrailStroke = null, this.activeTrailOwnerId = null, this.nextTrailOwnerId = 1, this.trailShardCounts = /* @__PURE__ */ new Map(), this.activePointerId = null, this.activePointerSource = null, this.fallbackTouchPointerId = null, this.lastPointerPosition = null, this.lastPointerTime = 0, this.lastInputSampleSourceTime = null, this.trailDistanceSinceShard = 0, this.touchGestureStarts = /* @__PURE__ */ new Map(), this.touchPointerFilterResults = [], this.closedShadowPointerDecisions = /* @__PURE__ */ new WeakMap(), this.usesTouchInputFallback = Gi(), this.touchActionListenersAttached = !1, this.closedShadowTouchListenersAttached = !1;
		...
		if (this.clickTimeMs = 0, this.trailTimeMs = 0, this.lastClickTimeSource = s, this.lastTrailTimeSource = s, this.animationFrame = null, this.lastFrameTime = null, this.renderingFrame = !1, this.paused = !1, this.destroyed = !1, this.domPointerListenersAttached = !1, this._onResize = () => this._resize(), this._onPointerDown = this._handlePointerDown.bind(this), this._onPointerMove = this._handlePointerMove.bind(this), this._onPointerUp = this._handlePointerUp.bind(this), this._onPointerCancel = this._handlePointerCancel.bind(this), this._onClosedShadowPointerDown = this._handleClosedShadowPointerDown.bind(this), this._onTouchStart = this._handleTouchStart.bind(this), this._onTouchMove = this._handleTouchMove.bind(this), this._onTouchEnd = this._handleTouchEnd.bind(this), this._onBlur = this._cancelPointer.bind(this), this._onFrame = this._renderFrame.bind(this), this._onWebGLContextLost = this._handleWebGLContextLost.bind(this), this._onWebGLContextRestored = this._handleWebGLContextRestored.bind(this), this._onWebGLEffectContextLost = this._handleWebGLEffectContextLost.bind(this), this._onWebGLEffectContextRestored = this._handleWebGLEffectContextRestored.bind(this), this._onCanvasSceneContextLost = this._handleCanvasSceneContextLost.bind(this), this._onCanvasSceneContextRestored = this._handleCanvasSceneContextRestored.bind(this), this._resize(), a && !o && !this._prepareWebGLEffectBackend()) {
			if (this.context = this.canvas.getContext("2d"), !this.context) throw this.animationFrame !== null && (Wi(this.animationFrame), this.animationFrame = null), Error("BAClickFX 无法在 OffscreenCanvas 上初始化 WebGL2；请使用新的画布并显式选择 Canvas2D");
	...
	_syncTouchActionListeners() {
		this.domPointerListenersAttached && (this.usesTouchInputFallback || Xi(this.config.touchAction).requiresShim) ? this._attachTouchActionListeners() : this._detachTouchActionListeners();
	}
	...
	_touchInputsMatch(e, t, n, r, i) {
		...
		return Math.abs(t.clientX - n) <= Vi && Math.abs(t.clientY - r) <= Vi && (a || this._touchTargetsMatch(e, t.target, i));
	}
	...
	_handleTouchStart(e) {
		...
		let t = e.changedTouches, n = Xi(this.config.touchAction), r = (e.touches ?? t)?.[0]?.identifier;
	...
	_isTouchDirectionAllowed(e, t, n) {
		return t === "x" ? e.allowX ? e.xDirections.has(n < 0 ? W.negative : W.positive) : !1 : e.allowY ? e.yDirections.has(n < 0 ? W.negative : W.positive) : !1;
	}
	...
	_usesIndependentHostPayload() {
		return je(this._getEffectiveHostCompositing());
	}
	...
	_syncHostCompositingState() {
		...
		if (this.hostCompositingState = t, !(n || typeof CustomEvent != "function" || typeof this.canvas?.dispatchEvent != "function")) try {
			this.canvas.dispatchEvent(new CustomEvent(Fi, { detail: { ...t } }));
		} catch {}
	}
	...
	_applyLegacyParams(e = this.fxConfig) {
		e.trail.gradient = structuredClone(to), e.trail.coreWidth = eo, e.trail.width = $a, e.bloom.trailAlpha = 0, e.bloom.ringBlur = 80, e.bloom.diskBlur = 65, e.bloom.shardBlur = 0;
	}
	_createFxParamResetBaseline() {
		let e = structuredClone(P);
		return this.config.renderingMode === "legacy" && this._applyLegacyParams(e), e;
	}
	...
	_resize(e, t, n) {
		...
		let r = this._getCanvasRect(), i = typeof window < "u" ? window.innerWidth : this.canvas?.width, a = typeof window < "u" ? window.innerHeight : this.canvas?.height, o = typeof window < "u" ? window.devicePixelRatio : 1, s = Hi(r.width, Hi(i, 1)), c = Hi(r.height, Hi(a, 1)), l = Hi(e, s), u = Hi(t, c), d = Math.min(Hi(n, Hi(o, 1)), this.config.maxDpr);
	...
	_getCanvasRect() {
		return this.host && !Da(this.host) && typeof this.host.getBoundingClientRect == "function" ? this.host.getBoundingClientRect() : typeof this.canvas?.getBoundingClientRect == "function" ? this.canvas.getBoundingClientRect() : {
			left: 0,
			top: 0,
	...
	_getPointerPosition(e) {
		...
		return {
			x: K(e.clientX - t.left, 0, this.width),
			y: K(e.clientY - t.top, 0, this.height)
		};
	}
	_normalizePointerInput(e) {
		return !e || !Number.isFinite(e.x) || !Number.isFinite(e.y) || e.pointerId !== void 0 && !Number.isFinite(e.pointerId) || e.pointerType !== void 0 && e.pointerType !== "mouse" && e.pointerType !== "touch" && e.pointerType !== "pen" ? null : {
			x: K(e.x, 0, this.width),
			y: K(e.y, 0, this.height),
	...
	_getDomTrailSampleTime(e, t, n) {
		...
		return Math.max(0, n - oa(r, this.config.trailTimeScale));
	}
	...
	_advanceClickTime(e = performance.now()) {
		...
		if (t <= 0) return 0;
		let n = oa(t, this.config.clickTimeScale);
	...
	_advanceTrailTime(e = performance.now()) {
		...
		if (t <= 0) return 0;
		let n = oa(t, this.config.trailTimeScale);
		return this.trailTimeMs += n, this.lastTrailTimeSource = e, n;
	}
	_getScale() {
		return this.config.scale * (this.height / P.referenceHeight) * 1;
	}
	...
	_ensureCurrentTrailStroke(e) {
		this.lastPointerPosition && (this.currentTrailStroke ? (this.currentTrailStroke.points.length === 0 || this.currentTrailStroke.points.length === 1 && e - this.currentTrailStroke.points[0].bornAt >= this.fxConfig.trail.lifetimeMs) && (this.currentTrailStroke.points.length = 0, this.currentTrailStroke.points.push(Oo(this.lastPointerPosition.x, this.lastPointerPosition.y, e)), this.lastPointerTime = e, this.trailDistanceSinceShard = 0) : (this._startTrailStroke(this.lastPointerPosition, e), this.lastPointerTime = e, this.trailDistanceSinceShard = 0));
	}
	_appendPointerSample(e, t) {
		if (!this.currentTrailStroke || !this.lastPointerPosition) return;
		let n = this.lastPointerPosition, r = da(n, e), i = this._getScale(), a = Math.max(.5, this.fxConfig.trail.minVertexDistance * i);
		if (r < a) return;
		let o = Math.min(512, Math.floor(r / a));
		for (let r = 1; r <= o; r++) {
			let i = r / o, a = J(n.x, e.x, i), s = J(n.y, e.y, i), c = J(this.lastPointerTime, t, i);
			this.currentTrailStroke.points.push(Oo(a, s, c));
		}
	...
	_spawnTrailShards(e, t, n, r, i) {
		let a = da(e, t), o = Math.max(1, this.fxConfig.shards.trailSpacing * n), s = o - this.trailDistanceSinceShard, c = this.currentTrailStroke?.ownerId ?? this.activeTrailOwnerId, l = Number.isFinite(c) ? this.trailShardCounts.get(c) ?? 0 : 0;
		for (; Number.isFinite(c) && s <= a && l < this.fxConfig.shards.maxCount;) {
			let u = a > 0 ? s / a : 0, d = J(e.x, t.x, u), f = J(e.y, t.y, u), p = ua(0, U);
			this.shards.push(Do(d, f, p, "trail", n, this.fxConfig.shards, J(r, i, u), c)), l++, this.trailShardCounts.set(c, l), s += o;
		}
	...
	_spawnClick(e, t) {
		...
		this.waves.push(new To(e, t, this.fxConfig, r));
		for (let i = 0; i < this.fxConfig.shards.clickCount; i++) this.shards.push(Do(e, t, ua(0, U), "click", n, this.fxConfig.shards, r));
	}
	_requestRender() {
		this.destroyed || this.paused || this.animationFrame !== null || (this.lastFrameTime = this.lastFrameTime ?? performance.now(), this.animationFrame = Ui(this._onFrame));
	}
	_renderFrame(e) {
		...
		let t = this._getScale(), n = this._isLegacy, r = this._prepareEffectBackend(), i = r !== null, a = n ? "legacy" : i ? r : this._resolveBloomBackend();
		this._setResolvedBloomBackend(a), !n && !i && this.resolvedBloomBackend !== a && (a = this._resolveBloomBackend());
		let o = a === "software", s = a === "webgl2", c = n || a === "native", l = this._prepareCanvasSceneBackend(i, a, n), u = !n && !i && a === "native" && !l && this._hasCachedSoftwareBloomFrame(t);
		u && (c = !1);
		let d = !i && !l && !s, f = d && c && this._usesUnknownBrowserOverlay() && !this._usesIndependentHostPayload() && this._getOverlayAlphaPolicy() === "visual-max", p = d && !f, m = !1;
		if (this.lastFrameTime = e, i || (this._setWebGLEffectVisible(!1), this._setWebGPUEffectVisible(!1)), !l) {
			let e = this.canvasSceneVisible;
			this._setCanvasSceneVisible(!1), e && this._setCanvasOutputVisible(!0);
		}
		this._setWebGLBloomVisible(!i && s), !this.context && !i && (this.context = this.canvas.getContext?.("2d") ?? null), this.context && (this.context.setTransform(this.dpr, 0, 0, this.dpr, 0, 0), this.context.clearRect(0, 0, this.width, this.height));
		let h = $i, g = G, _ = !1;
		this.canvasNativeSceneAlphaSnapshot = null;
		try {
			if (!i && this.context && (this.context.save(), _ = !0), $i = this._themeHueShift, G = this._relativeOklchTheme, this.context && (this.context.globalCompositeOperation = this._getCanvasOutputCompositing() === "browser-overlay" ? "source-over" : "lighter"), this.renderingFrame = !0, this._updateTrail(this.trailTimeMs, t, c, n, p, i || s), this._updateWaves(this.clickTimeMs, t, c, p), this._updateShards(this.clickTimeMs, this.trailTimeMs, t, p), i) if (this._renderGPUClickEffects(r, t)) this._setWebGLEffectVisible(r === "webgl2"), this._setWebGPUEffectVisible(r === "webgpu"), this._setResolvedEffectBackend(r);
			else {
				let e = r;
				i = !1, r = null, this._setResolvedEffectBackend(e === "webgpu" ? "pending" : "canvas2d"), this._setWebGLEffectVisible(!1), this._setWebGPUEffectVisible(!1), a = this._resolveBloomBackend(), o = a === "software", s = a === "webgl2", c = a === "native", this._setResolvedBloomBackend(a), this.resolvedBloomBackend !== a && (a = this._resolveBloomBackend(), o = a === "software", s = a === "webgl2", c = a === "native"), this._setWebGLBloomVisible(s), this._drawCanvasFallbackFrame(t, c, n);
			}
			else l ? (m = this._renderCanvasSceneEffects(t, c, n), m || (this._setCanvasSceneVisible(!1), this._drawCanvasFallbackFrame(t, c, n)), this._setCanvasSceneVisible(m), this._setCanvasOutputVisible(!m)) : s || (f ? this._drawCanvasFallbackFrame(t, c, n) : this._drawWaveRings(t, c, n));
			if (n) this._clearLightBackgroundContrast();
			else {
				let e = i || s || m;
				this._renderLightBackgroundContrast(t, o && !e);
			}
			u ? this._drawCachedSoftwareBloomFrame(t) || (this._drawCanvasFallbackFrame(t, !0, !1), this._renderLightBackgroundContrast(t, !1)) : !i && o && this._hasVisibleEffects() ? this._renderSoftwareBloom(t) : !i && s && this._hasVisibleEffects() ? this._renderWebGL2Bloom(t) : !i && s && this.webglBloomRenderer?.clear(), this._finalizeCanvasOverlayAlpha(t);
		} catch (e) {
			console.error("[BAClickFX] render error:", e), l && (this._setCanvasSceneVisible(!1), this._setCanvasOutputVisible(!0));
		} finally {
			this.renderingFrame = !1, $i = h, G = g, _ && this.context.restore();
		}
	...
	_getRequestedEffectBackendState() {
		let e = ye(this.config.effectBackend), t = Ea(this.canvas);
		if (this.config.renderingMode === "legacy" || e === "canvas2d" || !this.ownsCanvas && !t || this.ownsCanvas && !this.overlayParent) return "canvas2d";
		if (e === "webgpu" || e === "auto") {
	...
	_getRequestedBloomBackendState() {
		if (this.config.renderingMode === "legacy") return "legacy";
		let e = xe(this.config.bloomBackend), t = this._resolveCanvasFallbackBloomBackend();
		if (this.webgpuEffectVisible && this.webgpuEffectRenderer?.available) return "webgpu";
	...
	_setResolvedBloomBackend(e) {
		if (this.resolvedBloomBackend !== e && (this.resolvedBloomBackend = e, !(typeof CustomEvent != "function" || typeof this.canvas?.dispatchEvent != "function"))) try {
			this.canvas.dispatchEvent(new CustomEvent(Ni, { detail: {
	...
	_handleWebGPUEffectStateChange(e, t) {
		...
		let n = ye(this.config.effectBackend);
		if (t === "ready") {
			this.webgpuEffectUnavailable = !1, this.config.renderingMode !== "legacy" && (n === "webgpu" || n === "auto") && (this._setResolvedEffectBackend("pending"), this._requestRender());
			return;
		}
	...
	_ensureWebGPUEffectRenderer() {
		...
		let e = $();
		Va(e, !this.host && !this.config.isolatedCompositing, "2147483646", ""), e.style.display = "none", this.overlayParent.appendChild(e);
		let t = null;
		try {
			t = new si(e, {
	...
	_prepareEffectBackend() {
		let e = ye(this.config.effectBackend);
		if (this.config.renderingMode === "legacy" || e === "canvas2d") return this._setResolvedEffectBackend("canvas2d"), null;
		if (e === "webgpu" || e === "auto") {
	...
	_handleWebGLContextRestored() {
		if (this.destroyed || (this.webglBloomRenderer?.available || (this._destroyWebGLBloomRenderer(), this.webglBloomUnavailable = !1), this.paused || !this._hasVisibleEffects() || this.config.renderingMode === "legacy" || ye(this.config.effectBackend) !== "canvas2d")) return;
		let e = xe(this.config.bloomBackend);
	...
	_handleWebGLEffectContextRestored() {
		if (this.destroyed || (this.webglEffectRenderer?.available || (this._destroyWebGLEffectRenderer(), this.webglEffectUnavailable = !1), this.paused || !this._hasVisibleEffects())) return;
		let e = ye(this.config.effectBackend);
		this.config.renderingMode !== "legacy" && e !== "canvas2d" && (this._setResolvedEffectBackend("pending"), this._requestRender());
	}
	_ensureWebGLEffectRenderer() {
		...
		let e = Ea(this.canvas);
		if (!this.ownsCanvas && !e || this.ownsCanvas && !this.overlayParent) return !1;
		let t = this.ownsCanvas ? $() : this.canvas;
		this.ownsCanvas && this.overlayParent && (Va(t, !this.host && !this.config.isolatedCompositing, "2147483646", ""), t.style.display = "none", this.overlayParent.appendChild(t));
		let n = null;
		try {
			if (n = new Tr(t), !n.available) return this.webglEffectUnavailable = !0, n.destroy(), this.ownsCanvas && t.remove(), !1;
	...
	_prepareWebGLEffectBackend() {
		let e = ye(this.config.effectBackend);
		if (this.config.renderingMode === "legacy" || e === "canvas2d") return this._setResolvedEffectBackend("canvas2d"), !1;
		let t = this._ensureWebGLEffectRenderer() && this._resizeWebGLEffectRenderer();
		return t ? this.resolvedEffectBackend !== "webgl2" && this._setResolvedEffectBackend("pending") : this._setResolvedEffectBackend("canvas2d"), t;
	}
	...
	_handleCanvasSceneContextLost() {
		if (this.destroyed || !this.canvasSceneVisible) return;
		let e = this._isLegacy;
		this._setCanvasSceneVisible(!1), (this.paused || !this.renderingFrame) && this._restoreCanvasOutputAfterContextLoss(e ? "legacy" : "native", e), this._requestRender();
	}
	_handleCanvasSceneContextRestored() {
		this.destroyed || (this.canvasSceneRenderer?.available || (this._destroyCanvasSceneRenderer(), this.canvasSceneUnavailable = !1), !(!this._hasCompositingReference() || !this._hasVisibleEffects()) && (this._isLegacy || this.resolvedEffectBackend === "canvas2d" && this.resolvedBloomBackend === "native") && this._requestRender());
	}
	_ensureCanvasSceneRenderer() {
		...
		let t = null;
		try {
			if (t = new yi(e), !t.available) return this.canvasSceneUnavailable = !0, t.destroy(), e.remove(), !1;
			let n = this.compositingReferenceSource;
	...
	_prepareCanvasSceneBackend(e, t, n) {
		return e || !n && t !== "native" || !this._hasCompositingReference() ? !1 : this._ensureCanvasSceneRenderer() && this._resizeCanvasSceneRenderer() && this.canvasSceneRenderer.hasSceneBackground;
	}
	...
	_ensureWebGLBloomRenderer() {
		...
		let t = null;
		try {
			if (t = new Tr(e), !t.available) return this.webglBloomUnavailable = !0, t.destroy(), e.remove(), !1;
			let n = this.compositingReferenceSource;
	...
	_resolveCanvasFallbackBloomBackend() {
		return xe(this.config.bloomBackend) === "software" && this.bloomRenderer?.available ? "software" : "native";
	}
	...
	_setCanvasOutputVisible(e) {
		...
		if (this.canvas.style.visibility = t, this.contrastCanvas) {
			let t = !this._isLegacy && this.config.outputCompositing !== "browser-overlay" && this.config.lightBackgroundContrastAlpha > 0;
	...
	_getBloomRenderer(e) {
		for (; this.bloomRenderers.length <= e;) this.bloomRenderers.push(new Xt(() => $()));
	...
	_getLegacyRingRasterizer() {
		return this.legacyRingRasterizer === void 0 && (this.legacyRingRasterizer = Qa.create()), this.legacyRingRasterizer;
	}
	get _isLegacy() {
	...
	_renderLightBackgroundContrast(e, t = !1) {
		...
		if (!(!n || !this.contrastCanvas) && (n.setTransform(this.dpr, 0, 0, this.dpr, 0, 0), n.clearRect(0, 0, this.width, this.height), !(this.config.outputCompositing === "browser-overlay" || this.config.lightBackgroundContrastAlpha <= 0))) {
			if (t) n.save(), n.setTransform(1, 0, 0, 1, 0, 0), n.globalCompositeOperation = "source-over", n.drawImage(this.canvas, 0, 0), n.restore();
				...
				for (let t of this.trailStrokes) t.points.length >= 2 && Zo(n, t.points, e, this._getEffectiveOpacity(), this.fxConfig, !1, !1, null, t.trailFrameData);
			...
			n.save(), n.setTransform(1, 0, 0, 1, 0, 0), n.globalCompositeOperation = "source-in", n.fillStyle = ma(Mi, this.config.lightBackgroundContrastAlpha), n.fillRect(0, 0, this.contrastCanvas.width, this.contrastCanvas.height), n.restore();
		}
	}
	_getSoftwareBloomRegions(e) {
		...
		for (let t of this.waves) {
			...
			let n = t.ageMs / this.fxConfig.disk.lifetimeMs, r = t.ageMs / this.fxConfig.rings.lifetimeMs, a = n < 1 ? this.fxConfig.disk.radius * X(this.fxConfig.disk.sizeKeys, n) * e : 0;
			if (r < 1) for (let n of t.rings) {
				let t = Ya(n, r, e, this.fxConfig.rings);
		...
		for (let e of this.trailStrokes) {
			...
			let n = e.trailFrameData ?? Mo(e.points, this.fxConfig.trail, t.trailEmission), r = this._getEffectiveOpacity() * (this.fxConfig.trail.trailOpacity ?? 1) * t.trailEmissionAlpha / Math.max(1, t.emissionRange) * 255, o = [], s = null;
		...
		for (let t of this.shards) {
			let n = this.fxConfig.shards, r = q(t.ageMs / t.lifetimeMs), a = t.size * X(n.sizeKeys, r) * e;
		...
		return r.length === 0 ? [] : [{
			...
			width: this.width,
			height: this.height,
			emissionBounds: la(r.map((e) => e.emissionBounds)),
	...
	_getCanvasOverlayBounds(e) {
		...
		for (let t of this.waves) {
			...
			if (t.fx.hit.enabled && a < 1 && (i = Math.max(i, t.fx.hit.radius * e)), t.fx.flare.enabled && o < 1 && (i = Math.max(i, t.fx.flare.radius * e)), s < 1) {
				let n = t.fx.disk.radius * X(t.fx.disk.sizeKeys, s) * e, a = r.diskAlpha > 0 ? r.diskBlur * e * 3 : 0;
				i = Math.max(i, n + a);
			}
			if (c < 1) {
				let n = r.ringAlpha > 0 ? r.ringBlur * e * 3 : 0;
				for (let r of t.rings) {
					let a = Ya(r, c, e, t.fx.rings);
		...
		for (let t of this.shards) {
			let r = q(t.ageMs / t.lifetimeMs), i = t.size * X(this.fxConfig.shards.sizeKeys, r) * e;
			i > 0 && n(t.x - i, t.y - i, t.x + i, t.y + i);
		}
	...
	_renderSoftwareBloom(e) {
		let t = this.fxConfig.bloom, n = t.diffusion, r = this._getSoftwareBloomRegions(e), i = la(r), a = this._captureCanvasOverlayAlpha(e), o = this._prepareCanvasBloomTransportContext(), s = {
		...
		for (let i = 0; i < r.length; i++) {
			...
			for (let t of a.trailBatches) {
				let n = t.stroke;
				n.points.length >= 2 && $o(d, n.points, e, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData, t.firstSegment, t.lastSegment);
			}
			...
			if (d.restore(), f) {
				...
				for (let t of a.trailBatches) {
					let n = t.stroke;
					n.points.length >= 2 && Qo(f, n.points, e, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData, t.firstSegment, t.lastSegment);
				}
	...
	_renderWebGL2Scene(e, t) {
		...
		try {
			e.beginFrame();
			for (let n of this.trailStrokes) n.points.length < 2 || as(e, n.points, t, this._getEffectiveOpacity(), this.fxConfig, n.trailFrameData);
	...
	_renderCanvasSceneEffects(e, t, n) {
		let r = this.canvasSceneRenderer;
		if (!r?.available || r.contextLost) return !1;
		try {
			r.beginFrame(), this.context.globalCompositeOperation = "lighter", this._drawCanvasTrails(e, t, n, !0);
			for (let t of this.waves) t.drawDiskLayer(this.context, e, this._getEffectiveOpacity(), !1, this.dpr), t.appendCanvasSceneCoverage(r, e, this._getEffectiveOpacity());
			...
			return this._drawWaveRings(e, t, n, !0, "scene", "coverage", 1), r.render(this.canvas);
		} catch (e) {
			return console.warn("[BAClickFX] Canvas Scene Final Pass 渲染失败:", e), r.clear(), !1;
		}
	}
	_drawCanvasFallbackPass(e, t, n = !1) {
		this.context.setTransform(this.dpr, 0, 0, this.dpr, 0, 0), this.context.clearRect(0, 0, this.width, this.height), this.context.globalCompositeOperation = this._getCanvasOutputCompositing() === "browser-overlay" ? "source-over" : "lighter", this._drawCanvasTrails(e, t, n), this._drawCanvasClickEffects(e, t, n);
	}
	_drawCanvasFallbackFrame(e, t, n = !1) {
		this.canvasNativeSceneAlphaSnapshot = null, t && this._usesUnknownBrowserOverlay() && !this._usesIndependentHostPayload() && this._getOverlayAlphaPolicy() === "visual-max" && (this._drawCanvasFallbackPass(e, !1, n), this.canvasNativeSceneAlphaSnapshot = this._captureCanvasOverlayAlpha(e)), this._drawCanvasFallbackPass(e, t, n);
	}
	...
	_restoreCanvasOutputAfterContextLoss(e, t = !1) {
		let n = this._getScale(), r = $i, i = G, a = e;
		this._setResolvedBloomBackend(a), this.resolvedBloomBackend === "native" && (a = "native");
		let o = !1;
		try {
			this.context.save(), o = !0, $i = this._themeHueShift, G = this._relativeOklchTheme, this._drawCanvasFallbackFrame(n, t || a === "native", t), t || this._renderLightBackgroundContrast(n, a === "software"), a === "software" && this._hasVisibleEffects() && (this._renderSoftwareBloom(n), this.bloomRenderer.available || (a = "native"));
		} catch (e) {
			console.warn("[BAClickFX] WebGL Context 丢失回退失败:", e), a = t ? "legacy" : "native";
			try {
				this._drawCanvasFallbackFrame(n, !0, t), t || this._renderLightBackgroundContrast(n, !1);
			} catch (e) {
				console.warn("[BAClickFX] 原生 Canvas 回退失败:", e);
			}
		} finally {
			$i = r, G = i, o && this.context.restore();
		}
		this._finalizeCanvasOverlayAlpha(n), this._setResolvedBloomBackend(a), this._setCanvasOutputVisible(!0), this._flushCompositingMountRefresh();
	}
	_drawCanvasClickEffects(e, t, n = !1) {
		let r = this._getCanvasOutputCompositing(), i = "none", a = this._getEffectiveOverlayAlphaLimit();
		for (let n of this.waves) n.drawBase(this.context, e, this._getEffectiveOpacity(), t, r, this.dpr, i, a);
		for (let t of this.shards) t.draw(this.context, e, this._getEffectiveOpacity(), this.fxConfig, r, i, a);
		this._drawWaveRings(e, t, n, !1, r, i, a);
	}
	_drawCanvasTrails(e, t, n = !1, r = !1) {
		let i = t && !n ? this._getNativeTrailBloomSurface() : null, a = r ? "scene" : this._getCanvasOutputCompositing(), o = this._getEffectiveOverlayAlphaLimit();
		for (let s = this.trailStrokes.length - 1; s >= 0; s--) {
			let c = this.trailStrokes[s];
			c.points.length < 2 || (!n && !Array.isArray(c.trailFrameData?.segmentEnergies) && (c.trailFrameData = Mo(c.points, this.fxConfig.trail, this.fxConfig.bloom.trailEmission)), Zo(this.context, c.points, e, this._getEffectiveOpacity(), this.fxConfig, t, n, i, c.trailFrameData, r, a, "none", o));
		}
	}
	...
	_updateTrail(e, t, n, r = !1, i = !0, a = !1) {
		let o = this.fxConfig.trail.lifetimeMs;
		for (let t = this.trailStrokes.length - 1; t >= 0; t--) {
			let n = this.trailStrokes[t], i = 0;
			for (; i < n.points.length && e - n.points[i].bornAt >= o;) i++;
			if (i > 0 && n.points.splice(0, i), n.points.length >= 2) {
				let e = r || a ? null : this.fxConfig.bloom.trailEmission;
				n.trailFrameData = Mo(n.points, this.fxConfig.trail, e, !r);
			} else n.trailFrameData = null;
			!n.active && n.points.length < 2 && this.trailStrokes.splice(t, 1);
		}
		i && this._drawCanvasTrails(t, n, r);
	}
	...
	_drawWaveRings(e, t, n = !1, r = !1, i = this._getCanvasOutputCompositing(), a = "none", o = this._getEffectiveOverlayAlphaLimit()) {
		let s = n && this.waves.some((e) => e.rings.length > 0) ? this._getLegacyRingRasterizer() : null;
		for (let c of this.waves) c.drawRings(this.context, e, this._getEffectiveOpacity(), t, n, s, this.dpr, i, r, a, o);
	}
	...
	_hasVisibleEffects() {
		return this.waves.length > 0 || this.shards.length > 0 || this.trailStrokes.some((e) => ko(e.points));
	}
	boom(e = this.width / 2, t = this.height / 2) {
		this.destroyed || this.paused || !this.config.clickEnabled || (this._spawnClick(K(Number(e) || 0, 0, this.width), K(Number(t) || 0, 0, this.height)), this._requestRender());
	}
	setPaused(e, t = {}) {
		if (this.destroyed) return;
		if (e === !0) {
			if (!this.paused) {
				...
				this._advanceClickTime(e), this._advanceTrailTime(e), this.paused = !0, this.touchGestureStarts.clear(), this.touchPointerFilterResults.length = 0, this.closedShadowPointerDecisions = /* @__PURE__ */ new WeakMap(), this.activePointerId !== null && this._releaseActivePointer(), this.animationFrame !== null && (Wi(this.animationFrame), this.animationFrame = null), this.lastFrameTime = null, this.lastClickTimeSource = null, this.lastTrailTimeSource = null;
			}
	...
	_applyThemeColor(e) {
		let t = Re(e, ie);
		this.config.themeColor = t, this._themeHueShift = na(t), this._relativeOklchTheme = this.config.themeColorMode === "relative-oklch" ? st(t) : null;
	}
	setThemeColorMode(e) {
		return this.destroyed || !ze(e) ? !1 : (this.config.themeColorMode = e, this._relativeOklchTheme = e === "relative-oklch" ? st(this.config.themeColor) : null, this._requestRender(), !0);
	}
	setInputSamplingRate(e) {
		return this.destroyed || !Ce(e) ? !1 : (this.updateConfig({ inputSamplingRate: e }), !0);
	}
	updateConfig(e = {}) {
		if (this.destroyed) return;
		let t = this.config.effectBackend, n = this.config.webgpuPreferHdr, r = this.config.renderingMode, i = this.config.bloomBackend, o = this.config.outputCompositing, c = this.config.hostCompositing, l = this.config.hostCompositingSurface, u = ve(e.effectBackend) ? e.effectBackend : this.config.effectBackend, d = (e.renderingMode === "enhanced" || e.renderingMode === "legacy" ? e.renderingMode : this.config.renderingMode) === "legacy" || u === "canvas2d" ? "2d" : "webgl2", f = this._directOffscreenContextType === null || this._directOffscreenContextType === d, p = !1;
		if (Se(e.inputSource) && e.inputSource !== this.config.inputSource && (this._cancelPointer(), this.config.inputSource = e.inputSource, e.inputSource === "dom" ? this._attachDomPointerListeners() : this._detachDomPointerListeners()), Ce(e.inputSamplingRate) && e.inputSamplingRate !== this.config.inputSamplingRate && (this.config.inputSamplingRate = e.inputSamplingRate, this.lastInputSampleSourceTime = null), Ie(e.clickTimeScale) && (this._advanceClickTime(), this.config.clickTimeScale = e.clickTimeScale), Ie(e.trailTimeScale) && (this._advanceTrailTime(), this.config.trailTimeScale = e.trailTimeScale), Number.isFinite(e.scale) && (this.config.scale = Math.max(.01, e.scale)), Number.isFinite(e.opacity) && (this.config.opacity = q(e.opacity)), ze(e.themeColorMode) && (this.config.themeColorMode = Be(e.themeColorMode, ae)), (e.themeColor !== void 0 || ze(e.themeColorMode)) && this._applyThemeColor(e.themeColor === void 0 ? this.config.themeColor : e.themeColor), Te(e.outputCompositing) && (p = p || e.outputCompositing !== this.config.outputCompositing, this.config.outputCompositing = e.outputCompositing), a(e.overlayAlphaPolicy)) {
			let t = De(e.overlayAlphaPolicy, this.config.overlayAlphaPolicy);
			p = p || t !== this.config.overlayAlphaPolicy, this.config.overlayAlphaPolicy = t;
		}
		if (s(e.overlayColorCompensation)) {
			let t = Oe(e.overlayColorCompensation, this.config.overlayColorCompensation);
			p = p || t !== this.config.overlayColorCompensation, this.config.overlayColorCompensation = t;
		}
		if (Number.isFinite(e.overlayAlphaLimit)) {
			let t = ke(e.overlayAlphaLimit, this.config.overlayAlphaLimit);
			p = p || t !== this.config.overlayAlphaLimit, this.config.overlayAlphaLimit = t;
		}
		if (Ae(e.hostCompositing) && (p = p || e.hostCompositing !== this.config.hostCompositing, this.config.hostCompositing = e.hostCompositing), Ne(e.hostCompositingSurface) && (p = p || e.hostCompositingSurface !== this.config.hostCompositingSurface, this.config.hostCompositingSurface = e.hostCompositingSurface), typeof e.clickEnabled == "boolean" && (this.config.clickEnabled = e.clickEnabled), typeof e.trailEnabled == "boolean" && (this.config.trailEnabled = e.trailEnabled, e.trailEnabled || (this.activePointerSource === "hover" && this._releaseActivePointer(), this.clearTrail())), typeof e.trailAlways == "boolean" && (!e.trailAlways && this.activePointerSource === "hover" && this._releaseActivePointer(), this.config.trailAlways = e.trailAlways), ve(e.effectBackend) && f && (this.config.effectBackend = e.effectBackend), typeof e.webgpuPreferHdr == "boolean" && (this.config.webgpuPreferHdr = e.webgpuPreferHdr), (e.webgpuHdrPeak !== void 0 || e.webgpuHdrBrightness !== void 0 || e.webgpuHdrColorPreservation !== void 0 || e.webgpuHdrWhiteCore !== void 0 || e.webgpuHdrWhiteStart !== void 0 || e.webgpuHdrWhiteEnd !== void 0) && Object.assign(this.config, He(e, this.config)), f && (e.renderingMode === "enhanced" || e.renderingMode === "legacy")) {
			let t = this.config.renderingMode === "legacy", n = e.renderingMode === "legacy";
			this.config.renderingMode = e.renderingMode, t !== n && (n ? (this.ownsCanvas && (this.canvas.style.mixBlendMode = "", this.canvas.style.zIndex = "2147483647", this._setWebGLBloomVisible(!1), this.contrastCanvas && (this.contrastCanvas.style.display = "none")), this._applyLegacyParams()) : (this.ownsCanvas && (this.canvas.style.mixBlendMode = "", this.canvas.style.zIndex = "2147483646", this.contrastCanvas && (this.contrastCanvas.style.display = "")), this._commitFxParamConfig(this._createFxParamResetBaseline())));
		}
		be(e.bloomBackend) ? (this.config.bloomBackend = e.bloomBackend, this.config.softwareBloomEnabled = e.bloomBackend === "software") : typeof e.softwareBloomEnabled == "boolean" && (this.config.softwareBloomEnabled = e.softwareBloomEnabled, this.config.bloomBackend = e.softwareBloomEnabled ? "software" : "native");
		let m = n !== this.config.webgpuPreferHdr && (t === "webgpu" || t === "auto" || this.config.effectBackend === "webgpu" || this.config.effectBackend === "auto"), h = t !== this.config.effectBackend || r !== this.config.renderingMode || m, g = i !== this.config.bloomBackend;
		if (h ? (m && this.webgpuEffectRenderer?.setPreferHdr(this.config.webgpuPreferHdr), t !== this.config.effectBackend && (this.config.effectBackend === "webgpu" || this.config.effectBackend === "auto") && (this.webgpuEffectRenderer?.status === "lost" || this.webgpuEffectRenderer?.status === "unavailable") && (this._destroyWebGPUEffectRenderer(), this.webgpuEffectUnavailable = !1), this._releaseBackendFrameResources(), this._setResolvedEffectBackend(this._getRequestedEffectBackendState()), this._setResolvedBloomBackend(this._getRequestedBloomBackendState())) : g && this.resolvedEffectBackend !== "webgl2" && this.resolvedEffectBackend !== "webgpu" && (this._releaseBloomBackendFrameResources(), this._setResolvedBloomBackend(this._getRequestedBloomBackendState())), Number.isFinite(e.lightBackgroundContrastAlpha) && (this.config.lightBackgroundContrastAlpha = q(e.lightBackgroundContrastAlpha)), typeof e.isolatedCompositing == "boolean") {
			let t = this.ownsCanvas ? e.isolatedCompositing : !1;
			t !== this.config.isolatedCompositing && (this.config.isolatedCompositing = t);
		}
		o !== this.config.outputCompositing || c !== this.config.hostCompositing || l !== this.config.hostCompositingSurface ? this._requestCompositingMountRefresh() : typeof e.isolatedCompositing == "boolean" && this._applyCompositingMount(), p && (this.lastSoftwareBloomFrame = null), Number.isFinite(e.maxDpr) && (this.config.maxDpr = Math.max(1, e.maxDpr), this._resize()), e.touchAction !== void 0 && (this.config.touchAction = e.touchAction, this.canvas.style && (this.canvas.style.touchAction = e.touchAction), this._syncTouchActionListeners()), this._requestRender();
	}
	setFxParams(e, t = {}) {
		if (this.destroyed) return {
			applied: [],
	...
	setCompositingReference(e, t = {}) {
		...
		let n = t.fit ?? "cover";
		if (n !== "cover" || e !== null && !Oa(e)) return !1;
	...
	getConfig() {
		...
		return {
			...
			unity: structuredClone(P)
		};
	}
	_getResolvedWebGPUOutputMode() {
		let e = ye(this.config.effectBackend);
		if (this.config.renderingMode === "legacy" || e !== "webgpu" && e !== "auto" || !this.ownsCanvas || !this.overlayParent) return "unavailable";
	...
	destroy() {
		if (!this.destroyed) {
			this.destroyed = !0, typeof window < "u" && window.removeEventListener("resize", this._onResize), this._detachDomPointerListeners(), typeof window < "u" && window.removeEventListener("blur", this._onBlur), this.resizeObserver?.disconnect(), this.animationFrame !== null && (Wi(this.animationFrame), this.animationFrame = null), this.clear();
			for (let e of this.bloomRenderers) e.destroy();
			this._destroyWebGLBloomRenderer(), this._destroyWebGPUEffectRenderer(), this._destroyWebGLEffectRenderer(), this._destroyCanvasSceneRenderer(), this.nativeTrailBloomSurface && (this.nativeTrailBloomSurface.canvas.width = 0, this.nativeTrailBloomSurface.canvas.height = 0, this.nativeTrailBloomSurface = null), this.legacyRingRasterizer && (this.legacyRingRasterizer.destroy(), this.legacyRingRasterizer = null), this.canvasBloomTransportCanvas && (this.canvasBloomTransportCanvas.width = 0, this.canvasBloomTransportCanvas.height = 0, this.canvasBloomTransportCanvas = null, this.canvasBloomTransportContext = null), this.canvasNativeSceneAlphaSnapshot = null, this.ownsCanvas && (this.webglBloomCanvas?.remove(), this.contrastCanvas?.remove(), this.canvas.remove(), this.overlayRoot?.remove()), this.webglBloomCanvas = null, this.webglBloomVisible = !1, this.canvasSceneCanvas = null, this.canvasSceneVisible = !1, this.compositingReferenceSource = null, this.overlayParent = null, this.overlayMountParent = null, this.overlayRoot = null;
		}
	}
};
function ss(e, t = {}) {
...
//#endregion
export { os as BAClickFX, os as default, Ni as BLOOM_BACKEND_CHANGE_EVENT, I as CONFIG, ie as DEFAULT_THEME_COLOR, ae as DEFAULT_THEME_COLOR_MODE, Pi as EFFECT_BACKEND_CHANGE_EVENT, _e as FX_PARAM_MIGRATIONS, ge as FX_PARAM_SCHEMA, ce as FX_PARAM_SCHEMA_VERSION, Fi as HOST_COMPOSITING_CHANGE_EVENT, se as SIZE_CORRECTION, P as UNITY_FX_TOUCH, ss as applyFxParamPatch, Ue as createConfig };
